...
this.$active=this.$items=null;"hover"==this.options.pause&&this.$element.on("mouseenter.bs.carousel",a.proxy(this.pause,this)).on("mouseleave.bs.carousel",a.proxy(this.cycle,this))};d.VERSION="3.2.0";d.DEFAULTS={interval:5E3,pause:"hover",wrap:!0};d.prototype.keydown=function(a){switch(a.which){case 37:this.prev();break;case 39:this.next();break;default:return}a.preventDefault()};d.prototype.cycle=function(c){c||(this.paused=!1);this.interval&&clearInterval(this.interval);this.options.interval&&!this.paused&&
(this.interval=setInterval(a.proxy(this.next,this),this.options.interval));return this};d.prototype.getItemIndex=function(a){this.$items=a.parent().children(".item");return this.$items.index(a||this.$active)};d.prototype.to=function(c){var e=this,b=this.getItemIndex(this.$active=this.$element.find(".item.active"));if(!(c>this.$items.length-1||0>c))return this.sliding?this.$element.one("slid.bs.carousel",function(){e.to(c)}):b==c?this.pause().cycle():this.slide(c>b?"next":"prev",a(this.$items[c]))};
...
+function(a){var m=function(a,d){this.init("popover",a,d)};if(!a.fn.tooltip)throw Error("Popover requires tooltip.js");m.VERSION="3.2.0";m.DEFAULTS=a.extend({},a.fn.tooltip.Constructor.DEFAULTS,{placement:"right",trigger:"click",content:"",template:'<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-title"></h3><div class="popover-content"></div></div>'});m.prototype=a.extend({},a.fn.tooltip.Constructor.prototype);m.prototype.constructor=m;m.prototype.getDefaults=function(){return m.DEFAULTS};
m.prototype.setContent=function(){var a=this.tip(),d=this.getTitle(),e=this.getContent();a.find(".popover-title")[this.options.html?"html":"text"](d);a.find(".popover-content").empty()[this.options.html?"string"==typeof e?"html":"append":"text"](e);a.removeClass("fade top bottom left right in");a.find(".popover-title").html()||a.find(".popover-title").hide()};m.prototype.hasContent=function(){return this.getTitle()||this.getContent()};m.prototype.getContent=function(){var a=this.$element,d=this.options;
...
this.$form.trigger(f);this.$submitButton&&(d?this._onSuccess(f):this._onError(f))},_isExcluded:function(d){var f=d.attr("data-validate-excluded"),c=d.attr("data-validate-field")||d.attr("name");switch(!0){case !!c&&this.options.fields&&this.options.fields[c]&&("true"===this.options.fields[c].excluded||!0===this.options.fields[c].excluded):case "true"===f:case ""===f:return!0;case !!c&&this.options.fields&&this.options.fields[c]&&("false"===this.options.fields[c].excluded||!1===this.options.fields[c].excluded):case "false"===
f:return!1;default:if(this.options.excluded)for("string"===typeof this.options.excluded&&(this.options.excluded=a.map(this.options.excluded.split(","),function(d){return a.trim(d)})),f=this.options.excluded.length,c=0;c<f;c++)if("string"===typeof this.options.excluded[c]&&d.is(this.options.excluded[c])||"function"===typeof this.options.excluded[c]&&!0===this.options.excluded[c].call(this,d,this))return!0;return!1}},_exceedThreshold:function(d){var f=d.attr("data-validate-field");return(f=this.options.fields[f].threshold||
this.options.threshold)?-1!==a.inArray(d.attr("type"),"button checkbox file hidden image radio reset submit".split(" "))||d.val().length>=f:!0},_onError:function(d){if(!d.isDefaultPrevented()){if("submitted"===this.options.live){this.options.live="enabled";var f=this,c;for(c in this.options.fields)(function(b){b=f.getFieldElements(b);if(b.length){var d=a(b[0]).attr("type"),d="radio"===d||"checkbox"===d||"file"===d||"SELECT"===a(b[0]).get(0).tagName?"change":f._changeEvent,d=a.map((f.options.fields[c].trigger||
f.options.trigger||d).split(" "),function(b){return b+".live.validate"}).join(" ");b.off(d).on(d,function(){f._exceedThreshold(a(this))&&f.validateField(a(this))})}})(c)}for(var e=0;e<this.$invalidFields.length;e++)if(d=this.$invalidFields.eq(e),this._isOptionEnabled(d.attr("data-validate-field"),"autoFocus")){var e=d.parents(".tab-pane"),b;e&&(b=e.attr("id"))&&a('a[href="#'+b+'"][data-toggle="tab"]').tab("show");d.focus();break}}},_onSuccess:function(a){a.isDefaultPrevented()||this.defaultSubmit()},
_onFieldValidated:function(d,f){var c=d.attr("data-validate-field"),e=this.options.fields[c].validators,b={},k=0,h={validate:this,field:c,element:d,validator:f,result:d.data("validate.response."+f)};if(f)switch(d.data("validate.result."+f)){case this.STATUS_INVALID:d.trigger(a.Event(this.options.events.validatorError),h);break;case this.STATUS_VALID:d.trigger(a.Event(this.options.events.validatorSuccess),h)}b[this.STATUS_NOT_VALIDATED]=0;b[this.STATUS_VALIDATING]=0;b[this.STATUS_INVALID]=0;b[this.STATUS_VALID]=
0;for(var g in e)if(!1!==e[g].enabled){k++;var l=d.data("validate.result."+g);l&&b[l]++}b[this.STATUS_VALID]===k?(this.$invalidFields=this.$invalidFields.not(d),d.trigger(a.Event(this.options.events.fieldSuccess),h)):(0===b[this.STATUS_NOT_VALIDATED]||!this._isOptionEnabled(c,"verbose"))&&0===b[this.STATUS_VALIDATING]&&0<b[this.STATUS_INVALID]&&(this.$invalidFields=this.$invalidFields.add(d),d.trigger(a.Event(this.options.events.fieldError),h))},_isOptionEnabled:function(a,f){return!this.options.fields[a]||
"true"!==this.options.fields[a][f]&&!0!==this.options.fields[a][f]?!this.options.fields[a]||"false"!==this.options.fields[a][f]&&!1!==this.options.fields[a][f]?"true"===this.options[f]||!0===this.options[f]:!1:!0},getFieldElements:function(d){this._cacheFields[d]||(this._cacheFields[d]=this.options.fields[d]&&this.options.fields[d].selector?a(this.options.fields[d].selector):this.$form.find('[name="'+d+'"]'));return this._cacheFields[d]},getOptions:function(a,f,c){if(!a)return c?this.options[c]:this.options;
"object"===typeof a&&(a=a.attr("data-validate-field"));if(!this.options.fields[a])return null;a=this.options.fields[a];return f?a.validators&&a.validators[f]?c?a.validators[f][c]:a.validators[f]:null:c?a[c]:a},disableSubmitButtons:function(a){a?"disabled"!==this.options.live&&this.$form.find(this.options.submitButtons).attr("disabled","disabled"):this.$form.find(this.options.submitButtons).removeAttr("disabled");return this},validate:function(){if(!this.options.fields)return this;this._submitIfValid=
!1;for(var a in this.options.fields)this.validateField(a);this._submit();this._submitIfValid=!0;return this},validateField:function(d){var f=a([]);switch(typeof d){case "object":f=d;d=d.attr("data-validate-field");break;case "string":f=this.getFieldElements(d)}if(0===f.length||!this.options.fields[d]||!1===this.options.fields[d].enabled)return this;for(var c=this,e=f.attr("type"),b="radio"===e||"checkbox"===e?1:f.length,k="radio"===e||"checkbox"===e,e=this.options.fields[d].validators,h=this._isOptionEnabled(d,
"verbose"),g,l,m=0;m<b;m++){var u=f.eq(m);if(!this._isExcluded(u)){var n=!1;for(g in e){u.data("validate.dfs."+g)&&u.data("validate.dfs."+g).reject();if(n)break;l=u.data("validate.result."+g);if(l===this.STATUS_VALID||l===this.STATUS_INVALID)this._onFieldValidated(u,g);else if(!1===e[g].enabled)this.updateStatus(k?d:u,this.STATUS_VALID,g);else if(u.data("validate.result."+g,this.STATUS_VALIDATING),l=a.fn.Validator.validators[g].validate(this,u,e[g]),"object"===typeof l&&l.resolve)this.updateStatus(k?
d:u,this.STATUS_VALIDATING,g),u.data("validate.dfs."+g,l),l.done(function(a,b,d){a.removeData("validate.dfs."+b).data("validate.response."+b,d);d.message&&c.updateMessage(a,b,d.message);c.updateStatus(k?a.attr("data-validate-field"):a,d.valid?c.STATUS_VALID:c.STATUS_INVALID,b);d.valid&&!0===c._submitIfValid?c._submit():d.valid||h||(n=!0)});else if("object"===typeof l&&void 0!==l.valid&&void 0!==l.message){if(u.data("validate.response."+g,l),this.updateMessage(k?d:u,g,l.message),this.updateStatus(k?
d:u,l.valid?this.STATUS_VALID:this.STATUS_INVALID,g),!l.valid&&!h)break}else if("boolean"===typeof l&&(u.data("validate.response."+g,l),this.updateStatus(k?d:u,l?this.STATUS_VALID:this.STATUS_INVALID,g),!l&&!h))break}}}return this},updateMessage:function(d,f,c){var e=a([]);switch(typeof d){case "object":e=d;d=d.attr("data-validate-field");break;case "string":e=this.getFieldElements(d)}e.each(function(){a(this).data("validate.messages").find('.help-block[data-validate-validator="'+f+'"][data-validate-for="'+
d+'"]').html(c)})},updateStatus:function(d,f,c){var e=a([]);switch(typeof d){case "object":e=d;d=d.attr("data-validate-field");break;case "string":e=this.getFieldElements(d)}f===this.STATUS_NOT_VALIDATED&&(this._submitIfValid=!1);for(var b=e.attr("type"),k=this.options.fields[d].group||this.options.group,b="radio"===b||"checkbox"===b?1:e.length,h=0;h<b;h++){var g=e.eq(h);if(!this._isExcluded(g)){var l=g.parents(k),m=g.data("validate.messages").find('[class|=help][data-validate-validator][data-validate-for="'+
d+'"]'),u=c?m.filter('[data-validate-validator="'+c+'"]'):m,n=g.data("validate.icon"),v="function"===typeof(this.options.fields[d].container||this.options.container)?(this.options.fields[d].container||this.options.container).call(this,g,this):this.options.fields[d].container||this.options.container,C=null;if(c)g.data("validate.result."+c,f);else for(var s in this.options.fields[d].validators)g.data("validate.result."+s,f);u.attr("data-validate-result",f);var H=g.parents(".tab-pane"),Q,Z;H&&(Q=H.attr("id"))&&
(Z=a('a[href="#'+Q+'"][data-toggle="tab"]').parent());switch(f){case this.STATUS_VALIDATING:C=null;l.removeClass("has-success").removeClass("has-error");n&&n.removeClass(this.options.icons.valid).removeClass(this.options.icons.invalid).addClass(this.options.icons.validating).css("display","");Z&&Z.removeClass("validate-tab-success").removeClass("validate-tab-error");break;case this.STATUS_INVALID:C=!1;l.removeClass("has-success").addClass("has-error");n&&n.removeClass(this.options.icons.valid).removeClass(this.options.icons.validating).addClass(this.options.icons.invalid).css("display",
...
"has-success":"has-error");Z&&Z.removeClass("validate-tab-success").removeClass("validate-tab-error").addClass(this.isValidContainer(H)?"validate-tab-success":"validate-tab-error");break;default:C=null,l.removeClass("has-success").removeClass("has-error"),n&&n.removeClass(this.options.icons.valid).removeClass(this.options.icons.invalid).removeClass(this.options.icons.validating).hide(),Z&&Z.removeClass("validate-tab-success").removeClass("validate-tab-error")}switch(!0){case n&&"tooltip"===v:!1===
C?n.css("cursor","pointer").tooltip("destroy").tooltip({container:"body",html:!0,placement:"auto top",title:m.filter('[data-validate-result="'+this.STATUS_INVALID+'"]').eq(0).html()}):n.css("cursor","").tooltip("destroy");break;case n&&"popover"===v:!1===C?n.css("cursor","pointer").popover("destroy").popover({container:"body",content:m.filter('[data-validate-result="'+this.STATUS_INVALID+'"]').eq(0).html(),html:!0,placement:"auto top",trigger:"hover click"}):n.css("cursor","").popover("destroy");
...
k);this.updateStatus(d,this.STATUS_NOT_VALIDATED);f&&(e=c.attr("type"),"radio"===e||"checkbox"===e?c.removeAttr("checked").removeAttr("selected"):c.val(""));return this},resetForm:function(d){for(var f in this.options.fields)this.resetField(f,d);this.$invalidFields=a([]);this.$submitButton=null;return this},revalidateField:function(a){this.updateStatus(a,this.STATUS_NOT_VALIDATED).validateField(a);return this},enableFieldValidators:function(a,f,c){var e=this.options.fields[a].validators;if(c&&e&&
...
c.removeData("validate.result."+e).removeData("validate.response."+e).removeData("validate.dfs."+e),"function"===typeof a.fn.Validator.validators[e].destroy&&a.fn.Validator.validators[e].destroy(this,c,this.options.fields[d].validators[e])}}this.$hiddenButton.remove();this.$form.removeClass(this.options.elementClass).off(".validate").removeData("Validator").find("[data-validate-submit-hidden]").remove().end().find('[type="submit"]').off("click.validate")}};a.fn.Validator=function(d){var f=arguments;
return this.each(function(){var c=a(this),e=c.data("Validator"),b="object"===typeof d&&d;e||(e=new m(this,b),c.data("Validator",e));"string"===typeof d&&e[d].apply(e,Array.prototype.slice.call(f,1))})};a.fn.Validator.DEFAULT_OPTIONS={autoFocus:!0,container:null,elementClass:"validate-form",events:{formInit:"init.form.validate",formError:"error.form.validate",formSuccess:"success.form.validate",fieldAdded:"added.field.validate",fieldRemoved:"removed.field.validate",fieldInit:"init.field.validate",
...
v=parseInt(v,10);if(0>v||24<=v||g&&12<v)return!1}if(n){if(isNaN(n)||2<n.length)return!1;n=parseInt(n,10);if(0>n||59<n)return!1}}var h=a.fn.Validator.helpers.date(e,u,l),g=a.fn.Validator.i18n.date["default"],s=m=null,H=c.min,Q=c.max;H&&(isNaN(Date.parse(H))&&(H=d.getDynamicOption(f,H)),m=this._parseDate(H,k,b));Q&&(isNaN(Date.parse(Q))&&(Q=d.getDynamicOption(f,Q)),s=this._parseDate(Q,k,b));l=new Date(e,u,l,v,n,C);switch(!0){case H&&!Q&&h:h=l.getTime()>=m.getTime();g=c.message||a.fn.Validator.helpers.format(a.fn.Validator.i18n.date.min,
H);break;case Q&&!H&&h:h=l.getTime()<=s.getTime();g=c.message||a.fn.Validator.helpers.format(a.fn.Validator.i18n.date.max,Q);break;case Q&&H&&h:h=l.getTime()<=s.getTime()&&l.getTime()>=m.getTime(),g=c.message||a.fn.Validator.helpers.format(a.fn.Validator.i18n.date.range,[H,Q])}return{valid:h,message:g}},_parseDate:function(d,f,c){var e=0,b=0,k=0,h=d.split(" ");d=h[0];h=1<h.length?h[1]:null;d=d.split(c);c=d[a.inArray("YYYY",f)];var g=d[a.inArray("MM",f)];f=d[a.inArray("DD",f)];h&&(h=h.split(":"),b=
...
function n(a){a=+a;var b=0;0!==a&&isFinite(a)&&(b=0<=a?Math.floor(a):Math.ceil(a));return b}function v(a,b,c){var d=Math.min(a.length,b.length),e=Math.abs(a.length-b.length),f=0,z;for(z=0;z<d;z++)(c&&a[z]!==b[z]||!c&&n(a[z])!==n(b[z]))&&f++;return f+e}function C(){}function s(a){return a?a.toLowerCase().replace("_","-"):a}function H(a){var b=null;if(!ya[a]&&"undefined"!==typeof module&&module&&module.exports)try{b=Ma._abbr,require("./locale/"+a),Q(b)}catch(c){}return ya[a]}function Q(a,b){var c;a&&
(c="undefined"===typeof b?M(a):Z(a,b))&&(Ma=c);return Ma._abbr}function Z(a,b){if(null!==b)return b.abbr=a,ya[a]||(ya[a]=new C),ya[a].set(b),Q(a),ya[a];delete ya[a];return null}function M(a){var b;a&&a._locale&&a._locale._abbr&&(a=a._locale._abbr);if(!a)return Ma;if(!m(a)){if(b=H(a))return b;a=[a]}a:{b=0;for(var c,d,e,f;b<a.length;){f=s(a[b]).split("-");c=f.length;for(d=(d=s(a[b+1]))?d.split("-"):null;0<c;){if(e=H(f.slice(0,c).join("-"))){a=e;break a}if(d&&d.length>=c&&v(f,d,!0)>=c-1)break;c--}b++}a=
null}return a}function V(a,b){var c=a.toLowerCase();Ha[c]=Ha[c+"s"]=Ha[b]=a}function R(a){return"string"===typeof a?Ha[a]||Ha[a.toLowerCase()]:void 0}function ha(a){var b={},d,e;for(e in a)c(a,e)&&(d=R(e))&&(b[d]=a[e]);return b}function E(b,c){return function(d){return null!=d?(this._d["set"+(this._isUTC?"UTC":"")+b](d),a.updateOffset(this,c),this):r(this,b)}}function r(a,b){return a._d["get"+(a._isUTC?"UTC":"")+b]()}function F(a,b){var c;if("object"===typeof a)for(c in a)this.set(c,a[c]);else if(a=
R(a),"function"===typeof this[a])return this[a](b);return this}function p(a,b,c){for(var d=""+Math.abs(a);d.length<b;)d="0"+d;return(0<=a?c?"+":"":"-")+d}function x(a,b,c,d){var e=d;"string"===typeof d&&(e=function(){return this[d]()});a&&(Ea[a]=e);b&&(Ea[b[0]]=function(){return p(e.apply(this,arguments),b[1],b[2])});c&&(Ea[c]=function(){return this.localeData().ordinal(e.apply(this,arguments),a)})}function pa(a){return a.match(/\[[\s\S]/)?a.replace(/^\[|\]$/g,""):a.replace(/\\/g,"")}function J(a){var b=
...
b:function(a){return a&&c?c:b}}function Ja(a,b){return c(Za,a)?Za[a](b._strict,b._locale):RegExp(Y(a))}function Y(a){return a.replace("\\","").replace(/\\(\[)|\\(\])|\[([^\]\[]*)\]|\\(.)/g,function(a,b,c,d,e){return b||c||d||e}).replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")}function S(a,b){var c,d=b;"string"===typeof a&&(a=[a]);"number"===typeof b&&(d=function(a,c){c[b]=n(a)});for(c=0;c<a.length;c++)$a[a[c]]=d}function ta(a,b){S(a,function(a,c,d,e){d._w=d._w||{};b(a,d._w,d,e)})}function K(a,b){return(new Date(Date.UTC(a,
b+1,0))).getUTCDate()}function ea(a,b){var c;if("string"===typeof b&&(b=a.localeData().monthsParse(b),"number"!==typeof b))return a;c=Math.min(a.date(),K(a.year(),b));a._d["set"+(a._isUTC?"UTC":"")+"Month"](b,c);return a}function la(b){return null!=b?(ea(this,b),a.updateOffset(this,!0),this):r(this,"Month")}function ia(a){var b;(b=a._a)&&-2===k(a).overflow&&(b=0>b[qa]||11<b[qa]?qa:1>b[na]||b[na]>K(b[ra],b[qa])?na:0>b[ja]||24<b[ja]||24===b[ja]&&(0!==b[za]||0!==b[Aa]||0!==b[Ba])?ja:0>b[za]||59<b[za]?
za:0>b[Aa]||59<b[Aa]?Aa:0>b[Ba]||999<b[Ba]?Ba:-1,k(a)._overflowDayOfYear&&(b<ra||b>na)&&(b=na),k(a).overflow=b);return a}function G(b){!1===a.suppressDeprecationWarnings&&"undefined"!==typeof console&&console.warn&&console.warn("Deprecation warning: "+b)}function q(a,b){var c=!0,d=a+"\n"+Error().stack;return e(function(){c&&(G(d),c=!1);return b.apply(this,arguments)},b)}function W(a){var b,c,d=a._i,e=Ab.exec(d);if(e){k(a).iso=!0;b=0;for(c=ab.length;b<c;b++)if(ab[b][1].exec(d)){a._f=ab[b][0]+(e[6]||
" ");break}b=0;for(c=bb.length;b<c;b++)if(bb[b][1].exec(d)){a._f+=bb[b][0];break}d.match(Oa)&&(a._f+="Z");fa(a)}else a._isValid=!1}function da(b){var c=Bb.exec(b._i);null!==c?b._d=new Date(+c[1]):(W(b),!1===b._isValid&&(delete b._isValid,a.createFromInputFallback(b)))}function ba(a,b,c,d,e,f,z){b=new Date(a,b,c,d,e,f,z);1970>a&&b.setFullYear(a);return b}function t(a){var b=new Date(Date.UTC.apply(null,arguments));1970>a&&b.setUTCFullYear(a);return b}function T(a){return 0===a%4&&0!==a%100||0===a%
400}function O(a,b,c){b=c-b;c-=a.day();c>b&&(c-=7);c<b-7&&(c+=7);a=I(a).add(c,"d");return{week:Math.ceil(a.dayOfYear()/7),year:a.year()}}function U(a,b,c){return null!=a?a:null!=b?b:c}function D(a){var b,c,d=[],e;if(!a._d){e=new Date;e=a._useUTC?[e.getUTCFullYear(),e.getUTCMonth(),e.getUTCDate()]:[e.getFullYear(),e.getMonth(),e.getDate()];if(a._w&&null==a._a[na]&&null==a._a[qa]){var f,z,s;f=a._w;null!=f.GG||null!=f.W||null!=f.E?(b=1,s=4,c=U(f.GG,a._a[ra],O(I(),1,4).year),z=U(f.W,1),f=U(f.E,1)):(b=
a._locale._week.dow,s=a._locale._week.doy,c=U(f.gg,a._a[ra],O(I(),b,s).year),z=U(f.w,1),null!=f.d?(f=f.d,f<b&&++z):f=null!=f.e?f.e+b:b);var w=t(c,0,1).getUTCDay(),w=0===w?7:w;s=7*(z-1)+((null!=f?f:b)-b)+(b-w+(w>s?7:0)-(w<b?7:0))+1;b=0<s?c:c-1;c=0<s?s:(T(c-1)?366:365)+s;a._a[ra]=b;a._dayOfYear=c}a._dayOfYear&&(c=U(a._a[ra],e[ra]),a._dayOfYear>(T(c)?366:365)&&(k(a)._overflowDayOfYear=!0),c=t(c,0,a._dayOfYear),a._a[qa]=c.getUTCMonth(),a._a[na]=c.getUTCDate());for(c=0;3>c&&null==a._a[c];++c)a._a[c]=d[c]=
e[c];for(;7>c;c++)a._a[c]=d[c]=null==a._a[c]?2===c?1:0:a._a[c];24===a._a[ja]&&0===a._a[za]&&0===a._a[Aa]&&0===a._a[Ba]&&(a._nextDay=!0,a._a[ja]=0);a._d=(a._useUTC?t:ba).apply(null,d);null!=a._tzm&&a._d.setUTCMinutes(a._d.getUTCMinutes()-a._tzm);a._nextDay&&(a._a[ja]=24)}}function fa(b){if(b._f===a.ISO_8601)W(b);else{b._a=[];k(b).empty=!0;var d=""+b._i,e,f,z,s,w,ga=d.length,p=0;z=Ia(b._f,b._locale).match(hb)||[];for(e=0;e<z.length;e++){s=z[e];if(f=(d.match(Ja(s,b))||[])[0])w=d.substr(0,d.indexOf(f)),
...
ga||12!==z||(z=0)));d[e]=z;D(b);ia(b)}}function ca(a){if(!a._d){var b=ha(a._i);a._a=[b.year,b.month,b.day||b.date,b.hour,b.minute,b.second,b.millisecond];D(a)}}function aa(b){var c=b._i;void 0===c?b._d=new Date:d(c)?b._d=new Date(+c):"string"===typeof c?da(b):m(c)?(b._a=f(c.slice(0),function(a){return parseInt(a,10)}),D(b)):"object"===typeof c?ca(b):"number"===typeof c?b._d=new Date(c):a.createFromInputFallback(b)}function L(a,b,c,f,z){var s={};"boolean"===typeof c&&(f=c,c=void 0);s._isAMomentObject=
!0;s._useUTC=s._isUTC=z;s._l=c;s._i=a;s._f=b;s._strict=f;a=s._i;b=s._f;s._locale=s._locale||M(s._l);if(null===a||void 0===b&&""===a)s=g({nullInput:!0});else if("string"===typeof a&&(s._i=a=s._locale.preparse(a)),u(a))s=new y(ia(a));else{if(m(b)){var w,ga,p;if(0===s._f.length)k(s).invalidFormat=!0,s._d=new Date(NaN);else{for(a=0;a<s._f.length;a++)if(b=0,w=l({},s),null!=s._useUTC&&(w._useUTC=s._useUTC),w._f=s._f[a],fa(w),h(w)&&(b+=k(w).charsLeftOver,b+=10*k(w).unusedTokens.length,k(w).score=b,null==
p||b<p))p=b,ga=w;e(s,ga||w)}}else b?fa(s):d(a)?s._d=a:aa(s);s=new y(ia(s));s._nextDay&&(s.add(1,"d"),s._nextDay=void 0)}return s}function I(a,b,c,d){return L(a,b,c,d,!1)}function ua(a,b){var c,d;1===b.length&&m(b[0])&&(b=b[0]);if(!b.length)return I();c=b[0];for(d=1;d<b.length;++d)b[d][a](c)&&(c=b[d]);return c}function ga(a){a=ha(a);var b=a.year||0,c=a.quarter||0,d=a.month||0,e=a.week||0,f=a.day||0;this._milliseconds=+(a.millisecond||0)+1E3*(a.second||0)+6E4*(a.minute||0)+36E5*(a.hour||0);this._days=
+f+7*e;this._months=+d+3*c+12*b;this._data={};this._locale=M();this._bubble()}function z(a){return a instanceof ga}function w(a,b){x(a,0,0,function(){var a=this.utcOffset(),c="+";0>a&&(a=-a,c="-");return c+p(~~(a/60),2)+b+p(~~a%60,2)})}function cb(a){a=(a||"").match(Oa)||[];a=((a[a.length-1]||[])+"").match(Cb)||["-",0,0];var b=+(60*a[1])+n(a[2]);return"+"===a[0]?b:-b}function db(b,c){var e,f;return c._isUTC?(e=c.clone(),f=(u(b)||d(b)?+b:+I(b))-+e,e._d.setTime(+e._d+f),a.updateOffset(e,!1),e):I(b).local()}
...
new Date(a._i+(a._useUTC?" UTC":""))});x(0,["YY",2],0,function(){return this.year()%100});x(0,["YYYY",4],0,"year");x(0,["YYYYY",5],0,"year");x(0,["YYYYYY",6,!0],0,"year");V("year","y");A("Y",Va);A("YY",X,ka);A("YYYY",fb,eb);A("YYYYY",Ua,Sa);A("YYYYYY",Ua,Sa);S(["YYYY","YYYYY","YYYYYY"],ra);S("YY",function(b,c){c[ra]=a.parseTwoDigitYear(b)});a.parseTwoDigitYear=function(a){return n(a)+(68<n(a)?1900:2E3)};var xb=E("FullYear",!1);x("w",["ww",2],"wo","week");x("W",["WW",2],"Wo","isoWeek");V("week","w");
V("isoWeek","W");A("w",X);A("ww",X,ka);A("W",X);A("WW",X,ka);ta(["w","ww","W","WW"],function(a,b,c,d){b[d.substr(0,1)]=n(a)});x("DDD",["DDDD",3],"DDDo","dayOfYear");V("dayOfYear","DDD");A("DDD",Ta);A("DDDD",wb);S(["DDD","DDDD"],function(a,b,c){c._dayOfYear=n(a)});a.ISO_8601=function(){};var Gb=q("moment().min is deprecated, use moment.min instead. https://github.com/moment/moment/issues/1548",function(){var a=I.apply(null,arguments);return a<this?this:a}),Hb=q("moment().max is deprecated, use moment.max instead. https://github.com/moment/moment/issues/1548",
function(){var a=I.apply(null,arguments);return a>this?this:a});w("Z",":");w("ZZ","");A("Z",Oa);A("ZZ",Oa);S(["Z","ZZ"],function(a,b,c){c._useUTC=!0;c._tzm=cb(a)});var Cb=/([\+\-]|\d\d)/gi;a.updateOffset=function(){};var Db=/(\-)?(?:(\d*)\.)?(\d+)\:(\d+)(?:\:(\d+)\.?(\d{3})?)?/,Eb=/^(-)?P(?:(?:([0-9,.]*)Y)?(?:([0-9,.]*)M)?(?:([0-9,.]*)D)?(?:T(?:([0-9,.]*)H)?(?:([0-9,.]*)M)?(?:([0-9,.]*)S)?)?|([0-9,.]*)W)$/;va.fn=ga.prototype;var Ib=jb(1,"add"),Jb=jb(-1,"subtract");a.defaultFormat="YYYY-MM-DDTHH:mm:ssZ";
var yb=q("moment().lang() is deprecated. Instead, use moment().localeData() to get the language configuration. Use moment().locale() to change languages.",function(a){return void 0===a?this.localeData():this.locale(a)});x(0,["gg",2],0,function(){return this.weekYear()%100});x(0,["GG",2],0,function(){return this.isoWeekYear()%100});Qa("gggg","weekYear");Qa("ggggg","weekYear");Qa("GGGG","isoWeekYear");Qa("GGGGG","isoWeekYear");V("weekYear","gg");V("isoWeekYear","GG");A("G",Va);A("g",Va);A("GG",X,ka);
A("gg",X,ka);A("GGGG",fb,eb);A("gggg",fb,eb);A("GGGGG",Ua,Sa);A("ggggg",Ua,Sa);ta(["gggg","ggggg","GGGG","GGGGG"],function(a,b,c,d){b[d.substr(0,2)]=n(a)});ta(["gg","GG"],function(b,c,d,e){c[e]=a.parseTwoDigitYear(b)});x("Q",0,0,"quarter");V("quarter","Q");A("Q",vb);S("Q",function(a,b){b[qa]=3*(n(a)-1)});x("D",["DD",2],"Do","date");V("date","D");A("D",X);A("DD",X,ka);A("Do",function(a,b){return a?b._ordinalParse:b._ordinalParseLenient});S(["D","DD"],na);S("Do",function(a,b){b[na]=n(a.match(X)[0],
10)});var zb=E("Date",!0);x("d",0,"do","day");x("dd",0,0,function(a){return this.localeData().weekdaysMin(this,a)});x("ddd",0,0,function(a){return this.localeData().weekdaysShort(this,a)});x("dddd",0,0,function(a){return this.localeData().weekdays(this,a)});x("e",0,0,"weekday");x("E",0,0,"isoWeekday");V("day","d");V("weekday","e");V("isoWeekday","E");A("d",X);A("e",X);A("E",X);A("dd",La);A("ddd",La);A("dddd",La);ta(["dd","ddd","dddd"],function(a,b,c){var d=c._locale.weekdaysParse(a);null!=d?b.d=d:
k(c).invalidWeekday=a});ta(["d","e","E"],function(a,b,c,d){b[d]=n(a)});x("H",["HH",2],0,"hour");x("h",["hh",2],0,function(){return this.hours()%12||12});qb("a",!0);qb("A",!1);V("hour","h");A("a",rb);A("A",rb);A("H",X);A("h",X);A("HH",X,ka);A("hh",X,ka);S(["H","HH"],ja);S(["a","A"],function(a,b,c){c._isPm=c._locale.isPM(a);c._meridiem=a});S(["h","hh"],function(a,b,c){b[ja]=n(a);k(c).bigHour=!0});var Kb=E("Hours",!0);x("m",["mm",2],0,"minute");V("minute","m");A("m",X);A("mm",X,ka);S(["m","mm"],za);
var Lb=E("Minutes",!1);x("s",["ss",2],0,"second");V("second","s");A("s",X);A("ss",X,ka);S(["s","ss"],Aa);var Mb=E("Seconds",!1);x("S",0,0,function(){return~~(this.millisecond()/100)});x(0,["SS",2],0,function(){return~~(this.millisecond()/10)});x(0,["SSS",3],0,"millisecond");x(0,["SSSS",3],0,"millisecond");V("millisecond","ms");A("S",Ta,vb);A("SS",Ta,ka);A("SSS",Ta,wb);A("SSSS",/\d+/);S(["S","SS","SSS","SSSS"],function(a,b){b[Ba]=n(1E3*("0."+a))});var Nb=E("Milliseconds",!1);x("z",0,0,"zoneAbbr");
x("zz",0,0,"zoneName");var B=y.prototype;B.add=Ib;B.calendar=function(a){a=a||I();var b=db(a,this).startOf("day"),b=this.diff(b,"days",!0),b=-6>b?"sameElse":-1>b?"lastWeek":0>b?"lastDay":1>b?"sameDay":2>b?"nextDay":7>b?"nextWeek":"sameElse";return this.format(this.localeData().calendar(b,this,I(a)))};B.clone=function(){return new y(this)};B.diff=function(a,b,c){a=db(a,this);var d=6E4*(a.utcOffset()-this.utcOffset());b=R(b);if("year"===b||"month"===b||"quarter"===b){var d=12*(a.year()-this.year())+
(a.month()-this.month()),e=this.clone().add(d,"months"),f;0>a-e?(f=this.clone().add(d-1,"months"),a=(a-e)/(e-f)):(f=this.clone().add(d+1,"months"),a=(a-e)/(f-e));a=-(d+a);"quarter"===b?a/=3:"year"===b&&(a/=12)}else a=this-a,a="second"===b?a/1E3:"minute"===b?a/6E4:"hour"===b?a/36E5:"day"===b?(a-d)/864E5:"week"===b?(a-d)/6048E5:a;return c?a:oa(a)};B.endOf=function(a){a=R(a);return void 0===a||"millisecond"===a?this:this.startOf(a).add(1,"isoWeek"===a?"week":a).subtract(1,"ms")};B.format=function(b){b=
...
R("undefined"!==typeof b?b:"millisecond");return"millisecond"===b?(a=u(a)?a:I(a),+this>+a):(u(a)?+a:+I(a))<+this.clone().startOf(b)};B.isBefore=function(a,b){var c;b=R("undefined"!==typeof b?b:"millisecond");if("millisecond"===b)return a=u(a)?a:I(a),+this<+a;c=u(a)?+a:+I(a);return+this.clone().endOf(b)<c};B.isBetween=function(a,b,c){return this.isAfter(a,c)&&this.isBefore(b,c)};B.isSame=function(a,b){var c;b=R(b||"millisecond");if("millisecond"===b)return a=u(a)?a:I(a),+this===+a;c=+I(a);return+this.clone().startOf(b)<=
...
xb;B.isLeapYear=function(){return T(this.year())};B.weekYear=function(a){var b=O(this,this.localeData()._week.dow,this.localeData()._week.doy).year;return null==a?b:this.add(a-b,"y")};B.isoWeekYear=function(a){var b=O(this,1,4).year;return null==a?b:this.add(a-b,"y")};B.quarter=B.quarters=function(a){return null==a?Math.ceil((this.month()+1)/3):this.month(3*(a-1)+this.month()%3)};B.month=la;B.daysInMonth=function(){return K(this.year(),this.month())};B.week=B.weeks=function(a){var b=this.localeData().week(this);
return null==a?b:this.add(7*(a-b),"d")};B.isoWeek=B.isoWeeks=function(a){var b=O(this,1,4).week;return null==a?b:this.add(7*(a-b),"d")};B.weeksInYear=function(){var a=this.localeData()._week;return pb(this.year(),a.dow,a.doy)};B.isoWeeksInYear=function(){return pb(this.year(),1,4)};B.date=zb;B.day=B.days=function(a){var b=this._isUTC?this._d.getUTCDay():this._d.getDay();if(null!=a){a:{var c=this.localeData();if("string"===typeof a)if(isNaN(a)){if(a=c.weekdaysParse(a),"number"!==typeof a){a=null;break a}}else a=
...
q("years accessor is deprecated. Use year instead",xb);B.zone=q("moment().zone is deprecated, use moment().utcOffset instead. https://github.com/moment/moment/issues/1779",function(a,b){return null!=a?("string"!==typeof a&&(a=-a),this.utcOffset(a,b),this):-this.utcOffset()});var N=C.prototype;N._calendar={sameDay:"[Today at] LT",nextDay:"[Tomorrow at] LT",nextWeek:"dddd [at] LT",lastDay:"[Yesterday at] LT",lastWeek:"[Last] dddd [at] LT",sameElse:"L"};N.calendar=function(a,b,c){a=this._calendar[a];
return"function"===typeof a?a.call(b,c):a};N._longDateFormat={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY LT",LLLL:"dddd, MMMM D, YYYY LT"};N.longDateFormat=function(a){var b=this._longDateFormat[a];!b&&this._longDateFormat[a.toUpperCase()]&&(b=this._longDateFormat[a.toUpperCase()].replace(/MMMM|MM|DD|dddd/g,function(a){return a.slice(1)}),this._longDateFormat[a]=b);return b};N._invalidDate="Invalid date";N.invalidDate=function(){return this._invalidDate};N._ordinal=
"%d";N.ordinal=function(a){return this._ordinal.replace("%d",a)};N._ordinalParse=/\d{1,2}/;N.preparse=sb;N.postformat=sb;N._relativeTime={future:"in %s",past:"%s ago",s:"a few seconds",m:"a minute",mm:"%d minutes",h:"an hour",hh:"%d hours",d:"a day",dd:"%d days",M:"a month",MM:"%d months",y:"a year",yy:"%d years"};N.relativeTime=function(a,b,c,d){var e=this._relativeTime[c];return"function"===typeof e?e(a,b,c,d):e.replace(/%d/i,a)};N.pastFuture=function(a,b){var c=this._relativeTime[0<a?"future":
"past"];return"function"===typeof c?c(b):c.replace(/%s/i,b)};N.set=function(a){var b,c;for(c in a)b=a[c],"function"===typeof b?this[c]=b:this["_"+c]=b;this._ordinalParseLenient=RegExp(this._ordinalParse.source+"|"+/\d{1,2}/.source)};N.months=function(a){return this._months[a.month()]};N._months="January February March April May June July August September October November December".split(" ");N.monthsShort=function(a){return this._monthsShort[a.month()]};N._monthsShort="Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" ");
N.monthsParse=function(a,c,d){var e,f;this._monthsParse||(this._monthsParse=[],this._longMonthsParse=[],this._shortMonthsParse=[]);for(e=0;12>e;e++)if(f=b([2E3,e]),d&&!this._longMonthsParse[e]&&(this._longMonthsParse[e]=RegExp("^"+this.months(f,"").replace(".","")+"$","i"),this._shortMonthsParse[e]=RegExp("^"+this.monthsShort(f,"").replace(".","")+"$","i")),d||this._monthsParse[e]||(f="^"+this.months(f,"")+"|^"+this.monthsShort(f,""),this._monthsParse[e]=RegExp(f.replace(".",""),"i")),d&&"MMMM"===
c&&this._longMonthsParse[e].test(a)||d&&"MMM"===c&&this._shortMonthsParse[e].test(a)||!d&&this._monthsParse[e].test(a))return e};N.week=function(a){return O(a,this._week.dow,this._week.doy).week};N._week={dow:0,doy:6};N.firstDayOfYear=function(){return this._week.doy};N.firstDayOfWeek=function(){return this._week.dow};N.weekdays=function(a){return this._weekdays[a.day()]};N._weekdays="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" ");N.weekdaysMin=function(a){return this._weekdaysMin[a.day()]};
N._weekdaysMin="Su Mo Tu We Th Fr Sa".split(" ");N.weekdaysShort=function(a){return this._weekdaysShort[a.day()]};N._weekdaysShort="Sun Mon Tue Wed Thu Fri Sat".split(" ");N.weekdaysParse=function(a){var b,c;this._weekdaysParse||(this._weekdaysParse=[]);for(b=0;7>b;b++)if(this._weekdaysParse[b]||(c=I([2E3,1]).day(b),c="^"+this.weekdays(c,"")+"|^"+this.weekdaysShort(c,"")+"|^"+this.weekdaysMin(c,""),this._weekdaysParse[b]=RegExp(c.replace(".",""),"i")),this._weekdaysParse[b].test(a))return b};N.isPM=
function(a){return"p"===(a+"").toLowerCase().charAt(0)};N._meridiemParse=/[ap]\.?m?\.?/i;N.meridiem=function(a,b,c){return 11<a?c?"pm":"PM":c?"am":"AM"};Q("en",{ordinalParse:/\d{1,2}(th|st|nd|rd)/,ordinal:function(a){var b=a%10,b=1===n(a%100/10)?"th":1===b?"st":2===b?"nd":3===b?"rd":"th";return a+b}});a.lang=q("moment.lang is deprecated. Use moment.locale instead.",Q);a.langData=q("moment.langData is deprecated. Use moment.localeData instead.",M);var sa=Math.abs,Ob=wa("ms"),Pb=wa("s"),Qb=wa("m"),
Rb=wa("h"),Sb=wa("d"),Tb=wa("w"),Ub=wa("M"),Vb=wa("y"),Wb=Da("milliseconds"),Xb=Da("seconds"),Yb=Da("minutes"),Zb=Da("hours"),$b=Da("days"),ac=Da("months"),bc=Da("years"),Ga=Math.round,xa={s:45,m:45,h:22,d:26,M:11},Fa=Math.abs,P=ga.prototype;P.abs=function(){var a=this._data;this._milliseconds=sa(this._milliseconds);this._days=sa(this._days);this._months=sa(this._months);a.milliseconds=sa(a.milliseconds);a.seconds=sa(a.seconds);a.minutes=sa(a.minutes);a.hours=sa(a.hours);a.months=sa(a.months);a.years=
sa(a.years);return this};P.add=function(a,b){return ub(this,a,b,1)};P.subtract=function(a,b){return ub(this,a,b,-1)};P.as=function(a){var b,c=this._milliseconds;a=R(a);if("month"===a||"year"===a)return b=this._days+c/864E5,b=this._months+400*b/146097*12,"month"===a?b:b/12;b=this._days+Math.round(this._months/12*146097/400);switch(a){case "week":return b/7+c/6048E5;case "day":return b+c/864E5;case "hour":return 24*b+c/36E5;case "minute":return 1440*b+c/6E4;case "second":return 86400*b+c/1E3;case "millisecond":return Math.floor(864E5*
b)+c;default:throw Error("Unknown unit "+a);}};P.asMilliseconds=Ob;P.asSeconds=Pb;P.asMinutes=Qb;P.asHours=Rb;P.asDays=Sb;P.asWeeks=Tb;P.asMonths=Ub;P.asYears=Vb;P.valueOf=function(){return this._milliseconds+864E5*this._days+this._months%12*2592E6+31536E6*n(this._months/12)};P._bubble=function(){var a=this._milliseconds,b=this._days,c=this._months,d=this._data,e=0;d.milliseconds=a%1E3;a=oa(a/1E3);d.seconds=a%60;a=oa(a/60);d.minutes=a%60;a=oa(a/60);d.hours=a%24;b+=oa(a/24);e=oa(400*b/146097);b-=oa(146097*
e/400);c+=oa(b/30);b%=30;e+=oa(c/12);d.days=b;d.months=c%12;d.years=e;return this};P.get=function(a){a=R(a);return this[a+"s"]()};P.milliseconds=Wb;P.seconds=Xb;P.minutes=Yb;P.hours=Zb;P.days=$b;P.weeks=function(){return oa(this.days()/7)};P.months=ac;P.years=bc;P.humanize=function(a){var b=this.localeData(),c;c=!a;var d=va(this).abs(),e=Ga(d.as("s")),f=Ga(d.as("m")),z=Ga(d.as("h")),s=Ga(d.as("d")),w=Ga(d.as("M")),d=Ga(d.as("y")),e=e<xa.s&&["s",e]||1===f&&["m"]||f<xa.m&&["mm",f]||1===z&&["h"]||z<
xa.h&&["hh",z]||1===s&&["d"]||s<xa.d&&["dd",s]||1===w&&["M"]||w<xa.M&&["MM",w]||1===d&&["y"]||["yy",d];e[2]=c;e[3]=0<+this;e[4]=b;c=Fb.apply(null,e);a&&(c=b.pastFuture(+this,c));return b.postformat(c)};P.toISOString=Ra;P.toString=Ra;P.toJSON=Ra;P.locale=nb;P.localeData=ob;P.toIsoString=q("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)",Ra);P.lang=yb;x("X",0,0,"unix");x("x",0,0,"valueOf");A("x",Va);A("X",/[+-]?\d+(\.\d{1,3})?/);S("X",function(a,b,c){c._d=new Date(1E3*
parseFloat(a,10))});S("x",function(a,b,c){c._d=new Date(n(a))});a.version="2.10.3";gb=I;a.fn=B;a.min=function(){var a=[].slice.call(arguments,0);return ua("isBefore",a)};a.max=function(){var a=[].slice.call(arguments,0);return ua("isAfter",a)};a.utc=b;a.unix=function(a){return I(1E3*a)};a.months=function(a,b){return Ka(a,b,"months",12,"month")};a.isDate=d;a.locale=Q;a.invalid=g;a.duration=va;a.isMoment=u;a.weekdays=function(a,b){return Ka(a,b,"weekdays",7,"day")};a.parseZone=function(){return I.apply(null,
arguments).parseZone()};a.localeData=M;a.isDuration=z;a.monthsShort=function(a,b){return Ka(a,b,"monthsShort",12,"month")};a.weekdaysMin=function(a,b){return Ka(a,b,"weekdaysMin",7,"day")};a.defineLocale=Z;a.weekdaysShort=function(a,b){return Ka(a,b,"weekdaysShort",7,"day")};a.normalizeUnits=R;a.relativeTimeThreshold=function(a,b){if(void 0===xa[a])return!1;if(void 0===b)return xa[a];xa[a]=b;return!0};return a});/*
...
f=!0;for(r in e)if(e[r]&&e[r].show){f=!1;break}f&&(e.lines.show=!0)}null==e.lines.zero&&(e.lines.zero=!!e.lines.fill);e.xaxis=n(O,l(e,"x"));e.yaxis=n(U,l(e,"y"))}v()}function l(a,b){var c=a[b+"axis"];"object"==typeof c&&(c=c.n);"number"!=typeof c&&(c=1);return c}function y(){return a.grep(O.concat(U),function(a){return a})}function u(a){var b={},c,d;for(c=0;c<O.length;++c)(d=O[c])&&d.used&&(b["x"+d.n]=d.c2p(a.left));for(c=0;c<U.length;++c)(d=U[c])&&d.used&&(b["y"+d.n]=d.c2p(a.top));void 0!==b.x1&&
(b.x=b.x1);void 0!==b.y1&&(b.y=b.y1);return b}function n(b,c){b[c-1]||(b[c-1]={n:c,direction:b==O?"x":"y",options:a.extend(!0,{},b==O?q.xaxis:q.yaxis)});return b[c-1]}function v(){function b(a,c,d){c<a.datamin&&c!=-e&&(a.datamin=c);d>a.datamax&&d!=e&&(a.datamax=d)}var c=Number.POSITIVE_INFINITY,d=Number.NEGATIVE_INFINITY,e=Number.MAX_VALUE,f,p,k,r,g,m,x,l,K,F,q,E;a.each(y(),function(a,b){b.datamin=c;b.datamax=d;b.used=!1});for(f=0;f<G.length;++f)g=G[f],g.datapoints={points:[]},h(aa.processRawData,
...
m=g.datapoints.points;var t=g.lines.show&&g.lines.steps;g.xaxis.used=g.yaxis.used=!0;for(p=k=0;p<q.length;++p,k+=x){F=q[p];var Y=null==F;if(!Y)for(r=0;r<x;++r){l=F[r];if(K=E[r])K.number&&null!=l&&(l=+l,isNaN(l)?l=null:Infinity==l?l=e:-Infinity==l&&(l=-e)),null==l&&(K.required&&(Y=!0),null!=K.defaultValue&&(l=K.defaultValue));m[k+r]=l}if(Y)for(r=0;r<x;++r)l=m[k+r],null!=l&&(K=E[r],!1!==K.autoscale&&(K.x&&b(g.xaxis,l,l),K.y&&b(g.yaxis,l,l))),m[k+r]=null;else if(t&&0<k&&null!=m[k-x]&&m[k-x]!=m[k]&&m[k-
x+1]!=m[k+1]){for(r=0;r<x;++r)m[k+x+r]=m[k+r];m[k+1]=m[k-x+1];k+=x}}}}for(f=0;f<G.length;++f)g=G[f],h(aa.processDatapoints,[g,g.datapoints]);for(f=0;f<G.length;++f){g=G[f];m=g.datapoints.points;x=g.datapoints.pointsize;E=g.datapoints.format;F=k=c;t=q=d;for(p=0;p<m.length;p+=x)if(null!=m[p])for(r=0;r<x;++r)l=m[p+r],(K=E[r])&&!1!==K.autoscale&&l!=e&&l!=-e&&(K.x&&(l<k&&(k=l),l>q&&(q=l)),K.y&&(l<F&&(F=l),l>t&&(t=l)));if(g.bars.show){switch(g.bars.align){case "left":p=0;break;case "right":p=-g.bars.barWidth;
break;default:p=-g.bars.barWidth/2}g.bars.horizontal?(F+=p,t+=p+g.bars.barWidth):(k+=p,q+=p+g.bars.barWidth)}b(g.xaxis,k,q);b(g.yaxis,F,t)}a.each(y(),function(a,b){b.datamin==c&&(b.datamin=null);b.datamax==d&&(b.datamax=null)})}function C(){ua&&clearTimeout(ua);ba.unbind("mousemove",ma);ba.unbind("mouseleave",Ia);ba.unbind("click",A);h(aa.shutdown,[ba])}function s(a){function b(a){return a}var c,d,e=a.options.transform||b,f=a.options.inverseTransform;"x"==a.direction?(c=a.scale=fa/Math.abs(e(a.max)-
e(a.min)),d=Math.min(e(a.max),e(a.min))):(c=a.scale=ca/Math.abs(e(a.max)-e(a.min)),c=-c,d=Math.max(e(a.max),e(a.min)));a.p2c=e==b?function(a){return(a-d)*c}:function(a){return(e(a)-d)*c};a.c2p=f?function(a){return f(d+a/c)}:function(a){return d+a/c}}function H(b){var c=b.labelWidth,d=b.labelHeight,e=b.options.position,f="x"===b.direction,p=b.options.tickLength,k=q.grid.axisMargin,r=q.grid.labelMargin,g=!0,h=!0,l=!0,m=!1;a.each(f?O:U,function(a,c){c&&(c.show||c.reserveSpace)&&(c===b?m=!0:c.options.position===
e&&(m?h=!1:g=!1),m||(l=!1))});h&&(k=0);null==p&&(p=l?"full":5);isNaN(+p)||(r+=+p);f?(d+=r,"bottom"==e?(D.bottom+=d+k,b.box={top:W.height-D.bottom,height:d}):(b.box={top:D.top+k,height:d},D.top+=d+k)):(c+=r,"left"==e?(b.box={left:D.left+k,width:c},D.left+=c+k):(D.right+=c+k,b.box={left:W.width-D.right,width:c}));b.position=e;b.tickLength=p;b.box.padding=r;b.innermost=g}function Q(){var b=q.grid.minBorderMargin,c;if(null==b)for(c=b=0;c<G.length;++c)b=Math.max(b,2*(G[c].points.radius+G[c].points.lineWidth/
...
(d=0)),null==c.max&&(e+=f*z,0<e&&null!=b.datamax&&0>=b.datamax&&(e=0)))}b.min=d;b.max=e});if(d){e=a.grep(c,function(a){return a.show||a.reserveSpace});a.each(e,function(b,c){M(c);var d=c.options.ticks,e=[];null==d||"number"==typeof d&&0<d?e=c.tickGenerator(c):d&&(e=a.isFunction(d)?d(c):d);var f;c.ticks=[];for(d=0;d<e.length;++d){var z=null,p=e[d];"object"==typeof p?(f=+p[0],1<p.length&&(z=p[1])):f=+p;null==z&&(z=c.tickFormatter(f,c));isNaN(f)||c.ticks.push({v:f,label:z})}e=c.ticks;c.options.autoscaleMargin&&
0<e.length&&(null==c.options.min&&(c.min=Math.min(c.min,e[0].v)),null==c.options.max&&1<e.length&&(c.max=Math.max(c.max,e[e.length-1].v)));e=c.options;d=c.ticks||[];f=e.labelWidth||0;for(var z=e.labelHeight||0,p=f||("x"==c.direction?Math.floor(W.width/(d.length||1)):null),w="flot-"+c.direction+"-axis flot-"+c.direction+c.n+"-axis "+(c.direction+"Axis "+c.direction+c.n+"Axis"),k=e.font||"flot-tick-label tickLabel",r=0;r<d.length;++r){var g=d[r];g.label&&(g=W.getTextInfo(w,g.label,k,null,p),f=Math.max(f,
g.width),z=Math.max(z,g.height))}c.labelWidth=e.labelWidth||f;c.labelHeight=e.labelHeight||z});for(b=e.length-1;0<=b;--b)H(e[b]);Q();a.each(e,function(a,b){"x"==b.direction?(b.box.left=D.left-b.labelWidth/2,b.box.width=W.width-D.left-D.right+b.labelWidth):(b.box.top=D.top-b.labelHeight/2,b.box.height=W.height-D.bottom-D.top+b.labelHeight)})}fa=W.width-D.left-D.right;ca=W.height-D.bottom-D.top;a.each(c,function(a,b){s(b)});d&&E();J()}function M(b){var c=b.options,d;d="number"==typeof c.ticks&&0<c.ticks?
c.ticks:0.3*Math.sqrt("x"==b.direction?W.width:W.height);d=(b.max-b.min)/d;var e=-Math.floor(Math.log(d)/Math.LN10),f=c.tickDecimals;null!=f&&e>f&&(e=f);var p=Math.pow(10,-e),k=d/p,r;1.5>k?r=1:3>k?(r=2,2.25<k&&(null==f||e+1<=f)&&(r=2.5,++e)):r=7.5>k?5:10;r*=p;null!=c.minTickSize&&r<c.minTickSize&&(r=c.minTickSize);b.delta=d;b.tickDecimals=Math.max(0,null!=f?f:e);b.tickSize=c.tickSize||r;if("time"==c.mode&&!b.tickGenerator)throw Error("Time mode requires the flot.time plugin.");b.tickGenerator||(b.tickGenerator=
...
if(null!=c.alignTicksWithAxis){var g=("x"==b.direction?O:U)[c.alignTicksWithAxis-1];g&&g.used&&g!=b&&(d=b.tickGenerator(b),0<d.length&&(null==c.min&&(b.min=Math.min(b.min,d[0])),null==c.max&&1<d.length&&(b.max=Math.max(b.max,d[d.length-1]))),b.tickGenerator=function(a){var b=[],c,d;for(d=0;d<g.ticks.length;++d)c=(g.ticks[d].v-g.min)/(g.max-g.min),c=a.min+c*(a.max-a.min),b.push(c);return b},b.mode||null!=c.tickDecimals||(d=Math.max(0,-Math.floor(Math.log(b.delta)/Math.LN10)+1),e=b.tickGenerator(b),
1<e.length&&/\..*0$/.test((e[1]-e[0]).toFixed(d))||(b.tickDecimals=d)))}}function V(){W.clear();h(aa.drawBackground,[t]);var a=q.grid;a.show&&a.backgroundColor&&(t.save(),t.translate(D.left,D.top),t.fillStyle=ia(q.grid.backgroundColor,ca,0,"rgba(255, 255, 255, 0)"),t.fillRect(0,0,fa,ca),t.restore());a.show&&!a.aboveData&&ha();for(var b=0;b<G.length;++b){h(aa.drawSeries,[t,G[b]]);var c=G[b];c.lines.show&&r(c);c.bars.show&&x(c);c.points.show&&F(c)}h(aa.draw,[t]);a.show&&a.aboveData&&ha();W.render();
Y()}function R(a,b){for(var c,d,e,f,p=y(),k=0;k<p.length;++k)if(c=p[k],c.direction==b&&(f=b+c.n+"axis",a[f]||1!=c.n||(f=b+"axis"),a[f])){d=a[f].from;e=a[f].to;break}a[f]||(c="x"==b?O[0]:U[0],d=a[b+"1"],e=a[b+"2"]);null!=d&&null!=e&&d>e&&(f=d,d=e,e=f);return{from:d,to:e,axis:c}}function ha(){var b,c,d;t.save();t.translate(D.left,D.top);if(d=q.grid.markings)for(a.isFunction(d)&&(c=L.getAxes(),c.xmin=c.xaxis.min,c.xmax=c.xaxis.max,c.ymin=c.yaxis.min,c.ymax=c.yaxis.max,d=d(c)),b=0;b<d.length;++b){c=d[b];
var e=R(c,"x"),f=R(c,"y");null==e.from&&(e.from=e.axis.min);null==e.to&&(e.to=e.axis.max);null==f.from&&(f.from=f.axis.min);null==f.to&&(f.to=f.axis.max);if(!(e.to<e.axis.min||e.from>e.axis.max||f.to<f.axis.min||f.from>f.axis.max)){e.from=Math.max(e.from,e.axis.min);e.to=Math.min(e.to,e.axis.max);f.from=Math.max(f.from,f.axis.min);f.to=Math.min(f.to,f.axis.max);var p=e.from===e.to,k=f.from===f.to;if(!p||!k)if(e.from=Math.floor(e.axis.p2c(e.from)),e.to=Math.floor(e.axis.p2c(e.to)),f.from=Math.floor(f.axis.p2c(f.from)),
...
1;"x"==f.direction?(k=0,r="full"==p?"top"==f.position?0:ca:b.top-D.top+("top"==f.position?b.height:0)):(r=0,k="full"==p?"left"==f.position?0:fa:b.left-D.left+("left"==f.position?b.width:0));f.innermost||(t.strokeStyle=f.options.color,t.beginPath(),g=h=0,"x"==f.direction?g=fa+1:h=ca+1,1==t.lineWidth&&("x"==f.direction?r=Math.floor(r)+0.5:k=Math.floor(k)+0.5),t.moveTo(k,r),t.lineTo(k+g,r+h),t.stroke());t.strokeStyle=f.options.tickColor;t.beginPath();for(b=0;b<f.ticks.length;++b){var l=f.ticks[b].v;
g=h=0;isNaN(l)||l<f.min||l>f.max||"full"==p&&("object"==typeof d&&0<d[f.position]||0<d)&&(l==f.min||l==f.max)||("x"==f.direction?(k=f.p2c(l),h="full"==p?-ca:p,"top"==f.position&&(h=-h)):(r=f.p2c(l),g="full"==p?-fa:p,"left"==f.position&&(g=-g)),1==t.lineWidth&&("x"==f.direction?k=Math.floor(k)+0.5:r=Math.floor(r)+0.5),t.moveTo(k,r),t.lineTo(k+g,r+h))}t.stroke()}}d&&(b=q.grid.borderColor,"object"==typeof d||"object"==typeof b?("object"!==typeof d&&(d={top:d,right:d,bottom:d,left:d}),"object"!==typeof b&&
(b={top:b,right:b,bottom:b,left:b}),0<d.top&&(t.strokeStyle=b.top,t.lineWidth=d.top,t.beginPath(),t.moveTo(0-d.left,0-d.top/2),t.lineTo(fa,0-d.top/2),t.stroke()),0<d.right&&(t.strokeStyle=b.right,t.lineWidth=d.right,t.beginPath(),t.moveTo(fa+d.right/2,0-d.top),t.lineTo(fa+d.right/2,ca),t.stroke()),0<d.bottom&&(t.strokeStyle=b.bottom,t.lineWidth=d.bottom,t.beginPath(),t.moveTo(fa+d.right,ca+d.bottom/2),t.lineTo(0,ca+d.bottom/2),t.stroke()),0<d.left&&(t.strokeStyle=b.left,t.lineWidth=d.left,t.beginPath(),
t.moveTo(0-d.left/2,ca+d.bottom),t.lineTo(0-d.left/2,0),t.stroke())):(t.lineWidth=d,t.strokeStyle=q.grid.borderColor,t.strokeRect(-d/2,-d/2,fa+d,ca+d)));t.restore()}function E(){a.each(y(),function(a,b){var c=b.box,d="flot-"+b.direction+"-axis flot-"+b.direction+b.n+"-axis "+(b.direction+"Axis "+b.direction+b.n+"Axis"),e=b.options.font||"flot-tick-label tickLabel",f,p,k,r,g;W.removeText(d);if(b.show&&0!=b.ticks.length)for(var h=0;h<b.ticks.length;++h)f=b.ticks[h],!f.label||f.v<b.min||f.v>b.max||("x"==
b.direction?(r="center",p=D.left+b.p2c(f.v),"bottom"==b.position?k=c.top+c.padding:(k=c.top+c.height-c.padding,g="bottom")):(g="middle",k=D.top+b.p2c(f.v),"left"==b.position?(p=c.left+c.width-c.padding,r="right"):p=c.left+c.padding),W.addText(d,p,k,f.label,e,null,null,r,g))})}function r(a){function b(a,c,d,e,f){var z=a.points;a=a.pointsize;var p=null,k=null;t.beginPath();for(var r=a;r<z.length;r+=a){var g=z[r-a],h=z[r-a+1],w=z[r],l=z[r+1];if(null!=g&&null!=w){if(h<=l&&h<f.min){if(l<f.min)continue;
...
h)/(l-h)*(m-w)+w;h=b.min}else if(l<=h&&l<b.min){if(h<b.min)continue;m=(b.min-h)/(l-h)*(m-w)+w;l=b.min}if(h>=l&&h>b.max){if(l>b.max)continue;w=(b.max-h)/(l-h)*(m-w)+w;h=b.max}else if(l>=h&&l>b.max){if(h>b.max)continue;m=(b.max-h)/(l-h)*(m-w)+w;l=b.max}p||(t.beginPath(),t.moveTo(b.p2c(h),d.p2c(f)),p=!0);if(w>=d.max&&m>=d.max)t.lineTo(b.p2c(h),d.p2c(d.max)),t.lineTo(b.p2c(l),d.p2c(d.max));else if(w<=d.min&&m<=d.min)t.lineTo(b.p2c(h),d.p2c(d.min)),t.lineTo(b.p2c(l),d.p2c(d.min));else{var x=h,K=l;w<=m&&
w<d.min&&m>=d.min?(h=(d.min-w)/(m-w)*(l-h)+h,w=d.min):m<=w&&m<d.min&&w>=d.min&&(l=(d.min-w)/(m-w)*(l-h)+h,m=d.min);w>=m&&w>d.max&&m<=d.max?(h=(d.max-w)/(m-w)*(l-h)+h,w=d.max):m>=w&&m>d.max&&w<=d.max&&(l=(d.max-w)/(m-w)*(l-h)+h,m=d.max);h!=x&&t.lineTo(b.p2c(x),d.p2c(w));t.lineTo(b.p2c(h),d.p2c(w));t.lineTo(b.p2c(l),d.p2c(m));l!=K&&(t.lineTo(b.p2c(l),d.p2c(m)),t.lineTo(b.p2c(K),d.p2c(m)))}}}}t.save();t.translate(D.left,D.top);t.lineJoin="round";var d=a.lines.lineWidth,e=a.shadowSize;if(0<d&&0<e){t.lineWidth=
e;t.strokeStyle="rgba(0,0,0,0.1)";var f=Math.PI/18;b(a.datapoints,Math.sin(f)*(d/2+e/2),Math.cos(f)*(d/2+e/2),a.xaxis,a.yaxis);t.lineWidth=e/2;b(a.datapoints,Math.sin(f)*(d/2+e/4),Math.cos(f)*(d/2+e/4),a.xaxis,a.yaxis)}t.lineWidth=d;t.strokeStyle=a.color;if(e=pa(a.lines,a.color,0,ca))t.fillStyle=e,c(a.datapoints,a.xaxis,a.yaxis);0<d&&b(a.datapoints,0,0,a.xaxis,a.yaxis);t.restore()}function F(a){function b(a,c,d,e,f,z,p,k){var g=a.points;a=a.pointsize;for(var r=0;r<g.length;r+=a){var h=g[r],w=g[r+
...
D.left,10),d.pageY=parseInt(d.series.yaxis.p2c(d.datapoint[1])+e.top+D.top,10));if(q.grid.autoHighlight){for(e=0;e<I.length;++e)f=I[e],f.auto!=a||d&&f.series==d.series&&f.point[0]==d.datapoint[0]&&f.point[1]==d.datapoint[1]||K(f.series,f.point);d&&ta(d.series,d.datapoint,a)}c.trigger(a,[g,d])}function Y(){var a=q.interaction.redrawOverlayInterval;-1==a?S():ua||(ua=setTimeout(S,a))}function S(){ua=null;T.save();da.clear();T.translate(D.left,D.top);var b,c;for(b=0;b<I.length;++b)if(c=I[b],c.series.bars.show)la(c.series,
c.point);else{var d=c.series,e=c.point;c=e[0];var e=e[1],f=d.xaxis,p=d.yaxis,g="string"===typeof d.highlightColor?d.highlightColor:a.color.parse(d.color).scale("a",0.5).toString();if(!(c<f.min||c>f.max||e<p.min||e>p.max)){var k=d.points.radius+d.points.lineWidth/2;T.lineWidth=k;T.strokeStyle=g;g=1.5*k;c=f.p2c(c);e=p.p2c(e);T.beginPath();"circle"==d.points.symbol?T.arc(c,e,g,0,2*Math.PI,!1):d.points.symbol(T,c,e,g,!1);T.closePath();T.stroke()}}T.restore();h(aa.drawOverlay,[T])}function ta(a,b,c){"number"==
typeof a&&(a=G[a]);if("number"==typeof b){var d=a.datapoints.pointsize;b=a.datapoints.points.slice(d*b,d*(b+1))}d=ea(a,b);-1==d?(I.push({series:a,point:b,auto:c}),Y()):c||(I[d].auto=!1)}function K(a,b){if(null==a&&null==b)I=[],Y();else{"number"==typeof a&&(a=G[a]);if("number"==typeof b){var c=a.datapoints.pointsize;b=a.datapoints.points.slice(c*b,c*(b+1))}c=ea(a,b);-1!=c&&(I.splice(c,1),Y())}}function ea(a,b){for(var c=0;c<I.length;++c){var d=I[c];if(d.series==a&&d.point[0]==b[0]&&d.point[1]==b[1])return c}return-1}
function la(b,c){var d="string"===typeof b.highlightColor?b.highlightColor:a.color.parse(b.color).scale("a",0.5).toString(),e;switch(b.bars.align){case "left":e=0;break;case "right":e=-b.bars.barWidth;break;default:e=-b.bars.barWidth/2}T.lineWidth=b.bars.lineWidth;T.strokeStyle=d;p(c[0],c[1],c[2]||0,e,e+b.bars.barWidth,function(){return d},b.xaxis,b.yaxis,T,b.bars.horizontal,b.bars.lineWidth)}function ia(b,c,d,e){if("string"==typeof b)return b;c=t.createLinearGradient(0,d,0,c);d=0;for(var f=b.colors.length;d<
...
barWidth:1,fill:!0,fillColor:null,align:"left",horizontal:!1,zero:!0},shadowSize:3,highlightColor:null},grid:{show:!0,aboveData:!1,color:"#545454",backgroundColor:null,borderColor:null,tickColor:null,margin:0,labelMargin:5,axisMargin:8,borderWidth:2,minBorderMargin:null,markings:null,markingsColor:"#f4f4f4",markingsLineWidth:2,clickable:!1,hoverable:!1,autoHighlight:!0,mouseActiveRadius:10},interaction:{redrawOverlayInterval:1E3/60},hooks:{}},W=null,da=null,ba=null,t=null,T=null,O=[],U=[],D={left:0,
right:0,top:0,bottom:0},fa=0,ca=0,aa={processOptions:[],processRawData:[],processDatapoints:[],processOffset:[],drawBackground:[],drawSeries:[],draw:[],bindEvents:[],drawOverlay:[],shutdown:[]},L=this;L.setData=g;L.setupGrid=Z;L.draw=V;L.getPlaceholder=function(){return c};L.getCanvas=function(){return W.element};L.getPlotOffset=function(){return D};L.width=function(){return fa};L.height=function(){return ca};L.offset=function(){var a=ba.offset();a.left+=D.left;a.top+=D.top;return a};L.getData=function(){return G};
L.getAxes=function(){var b={};a.each(O.concat(U),function(a,c){c&&(b[c.direction+(1!=c.n?c.n:"")+"axis"]=c)});return b};L.getXAxes=function(){return O};L.getYAxes=function(){return U};L.c2p=u;L.p2c=function(a){var b={},c,d,e;for(c=0;c<O.length;++c)if((d=O[c])&&d.used&&(e="x"+d.n,null==a[e]&&1==d.n&&(e="x"),null!=a[e])){b.left=d.p2c(a[e]);break}for(c=0;c<U.length;++c)if((d=U[c])&&d.used&&(e="y"+d.n,null==a[e]&&1==d.n&&(e="y"),null!=a[e])){b.top=d.p2c(a[e]);break}return b};L.getOptions=function(){return q};
L.highlight=ta;L.unhighlight=K;L.triggerRedrawOverlay=Y;L.pointOffset=function(a){return{left:parseInt(O[l(a,"x")-1].p2c(+a.x)+D.left,10),top:parseInt(U[l(a,"y")-1].p2c(+a.y)+D.top,10)}};L.shutdown=C;L.destroy=function(){C();c.removeData("plot").empty();G=[];T=t=ba=da=W=q=null;O=[];U=[];aa=null;I=[];L=null};L.resize=function(){var a=c.width(),b=c.height();W.resize(a,b);da.resize(a,b)};L.hooks=aa;(function(){for(var b={Canvas:m},c=0;c<f.length;++c){var d=f[c];d.init(L,b);d.options&&a.extend(!0,q,d.options)}})(L);
...
q.series.bars,q.bars);null!=q.shadowSize&&(q.series.shadowSize=q.shadowSize);null!=q.highlightColor&&(q.series.highlightColor=q.highlightColor);for(b=0;b<q.xaxes.length;++b)n(O,b+1).options=q.xaxes[b];for(b=0;b<q.yaxes.length;++b)n(U,b+1).options=q.yaxes[b];for(var p in aa)q.hooks[p]&&q.hooks[p].length&&(aa[p]=aa[p].concat(q.hooks[p]));h(aa.processOptions,[q])})(b);(function(){c.css("padding",0).children().filter(function(){return!a(this).hasClass("flot-overlay")&&!a(this).hasClass("flot-base")}).remove();
"static"==c.css("position")&&c.css("position","relative");W=new m("flot-base",c);da=new m("flot-overlay",c);t=W.context;T=da.context;ba=a(da.element).unbind();var b=c.data("plot");b&&(b.shutdown(),da.clear());c.data("plot",L)})();g(d);Z();V();q.grid.hoverable&&(ba.mousemove(ma),ba.bind("mouseleave",Ia));q.grid.clickable&&ba.click(A);h(aa.bindEvents,[ba]);var I=[],ua=null}var f=Object.prototype.hasOwnProperty;a.fn.detach||(a.fn.detach=function(){return this.each(function(){this.parentNode&&this.parentNode.removeChild(this)})});
...
a.plot.version="0.8.3";a.plot.plugins=[];a.fn.plot=function(c,d){return this.each(function(){a.plot(this,c,d)})}})(jQuery);(function(a){function m(a,b){return b*Math.floor(a/b)}function d(a,b,c,d){if("function"==typeof a.strftime)return a.strftime(b);var e=function(a,b){a=""+a;return 1==a.length?""+(null==b?"0":b)+a:a},f=[],k=!1,h=a.getHours(),m=12>h;null==c&&(c="Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "));null==d&&(d="Sun Mon Tue Wed Thu Fri Sat".split(" "));var Q;Q=12<h?h-12:0==h?12:h;for(var Z=0;Z<b.length;++Z){var M=b.charAt(Z);if(k){switch(M){case "a":M=""+d[a.getDay()];break;case "b":M=""+c[a.getMonth()];
break;case "d":M=e(a.getDate());break;case "e":M=e(a.getDate()," ");break;case "h":case "H":M=e(h);break;case "I":M=e(Q);break;case "l":M=e(Q," ");break;case "m":M=e(a.getMonth()+1);break;case "M":M=e(a.getMinutes());break;case "q":M=""+(Math.floor(a.getMonth()/3)+1);break;case "S":M=e(a.getSeconds());break;case "y":M=e(a.getFullYear()%100);break;case "Y":M=""+a.getFullYear();break;case "p":M=m?"am":"pm";break;case "P":M=m?"AM":"PM";break;case "w":M=""+a.getDay()}f.push(M);k=!1}else"%"==M?k=!0:f.push(M)}return f.join("")}
...
u=k("BLOCKQUOTE"),Y=function(a){return A(a)||u(a)||g(a)},S=k("A"),v=k("BODY"),K=d.isMSIE?"&nbsp;":"<br>",ea=function(a){return h(a)?a.nodeValue.length:a.childNodes.length},la=function(a){var c=ea(a);return 0===c||!b.isText(a)&&1===c&&a.innerHTML===K?!0:!1},ia=function(a){p(a)||ea(a)||(a.innerHTML=K)},G=function(a,b){for(;a;){if(b(a))return a;if(g(a))break;a=a.parentNode}return null},q=function(a,b){b=b||f.fail;var c=[];G(a,function(a){g(a)||c.push(a);return b(a)});return c},y=function(a,b){b=b||f.fail;
for(var c=[];a&&!b(a);)c.push(a),a=a.nextSibling;return c},da=function(a,b){var c=b.nextSibling,d=b.parentNode;c?d.insertBefore(a,c):d.appendChild(a);return a},ba=function(b,c){a.each(c,function(a,c){b.appendChild(c)});return b},t=function(a){return 0===a.offset},T=function(a){return a.offset===ea(a.node)},O=function(a){for(var b=0;a=a.previousSibling;)b+=1;return b},U=function(a){return!!(a&&a.childNodes&&a.childNodes.length)},D=function(a,b){var c,d;if(0===a.offset){if(g(a.node))return null;c=a.node.parentNode;
d=O(a.node)}else U(a.node)?(c=a.node.childNodes[a.offset-1],d=ea(c)):(c=a.node,d=b?0:a.offset-1);return{node:c,offset:d}},C=function(a,b){var c,d;if(ea(a.node)===a.offset){if(g(a.node))return null;c=a.node.parentNode;d=O(a.node)+1}else U(a.node)?(c=a.node.childNodes[a.offset],d=0):(c=a.node,d=b?ea(a.node):a.offset+1);return{node:c,offset:d}},ca=function(a,b){return a.node===b.node&&a.offset===b.offset},aa=function(a,b){if(h(a.node))return t(a)?a.node:T(a)?a.node.nextSibling:a.node.splitText(a.offset);
var c=a.node.childNodes[a.offset],d=da(a.node.cloneNode(!1),a.node);ba(d,y(c));b||(ia(a.node),ia(d));return d},L=function(a,b,c){a=q(b.node,f.eq(a));return a.length?1===a.length?aa(b,c):a.reduce(function(a,d){var e=da(d.cloneNode(!1),d);a===b.node&&(a=aa(b,c));ba(e,y(a));c||(ia(d),ia(e));return e}):null},I=function(a){return document.createElement(a)},H=function(a,b){if(a&&a.parentNode){if(a.removeNode)return a.removeNode(b);var c=a.parentNode;if(!b){var d=[],e,f;e=0;for(f=a.childNodes.length;e<f;e++)d.push(a.childNodes[e]);
e=0;for(f=d.length;e<f;e++)c.insertBefore(d[e],a)}c.removeChild(a)}},M=k("TEXTAREA");return{NBSP_CHAR:e,ZERO_WIDTH_NBSP_CHAR:"﻿",blank:K,emptyPara:"<p>"+K+"</p>",makePredByNodeName:k,isEditable:g,isControlSizing:function(b){return b&&a(b).hasClass("note-control-sizing")},buildLayoutInfo:function(b){var d;if(b.hasClass("note-air-editor")){var e=c.last(b.attr("id").split("-"));d=function(b){return function(){return a(b+e)}};return{editor:function(){return b},editable:function(){return b},popover:d("#note-popover-"),
...
!!G(a,l)},isList:s,isTable:n,isCell:A,isBlockquote:u,isBodyContainer:Y,isAnchor:S,isDiv:k("DIV"),isLi:m,isBR:k("BR"),isSpan:k("SPAN"),isB:k("B"),isU:k("U"),isS:k("S"),isI:k("I"),isImg:k("IMG"),isTextarea:M,isEmpty:la,isEmptyAnchor:f.and(S,la),isClosestSibling:function(a,b){return a.nextSibling===b||a.previousSibling===b},withClosestSiblings:function(a,b){b=b||f.ok;var c=[];a.previousSibling&&b(a.previousSibling)&&c.push(a.previousSibling);c.push(a);a.nextSibling&&b(a.nextSibling)&&c.push(a.nextSibling);
return c},nodeLength:ea,isLeftEdgePoint:t,isRightEdgePoint:T,isEdgePoint:function(a){return t(a)||T(a)},isLeftEdgeOf:function(a,b){for(;a&&a!==b;){if(0!==O(a))return!1;a=a.parentNode}return!0},isRightEdgeOf:function(a,b){for(;a&&a!==b;){if(O(a)!==ea(a.parentNode)-1)return!1;a=a.parentNode}return!0},prevPoint:D,nextPoint:C,isSamePoint:ca,isVisiblePoint:function(a){if(h(a.node)||!U(a.node)||la(a.node))return!0;var b=a.node.childNodes[a.offset-1];a=a.node.childNodes[a.offset];return b&&!p(b)||a&&!p(a)?
!1:!0},prevPointUntil:function(a,b){for(;a;){if(b(a))return a;a=D(a)}return null},nextPointUntil:function(a,b){for(;a;){if(b(a))return a;a=C(a)}return null},walkPoint:function(a,b,c,d){for(var e=a;e;){c(e);if(ca(e,b))break;e=C(e,d&&a.node!==e.node&&b.node!==e.node)}},ancestor:G,singleChildAncestor:function(a,b){for(a=a.parentNode;a&&1===ea(a);){if(b(a))return a;if(g(a))break;a=a.parentNode}return null},listAncestor:q,lastAncestor:function(a,b){var d=q(a);return c.last(d.filter(b))},listNext:y,listPrev:function(a,
b){b=b||f.fail;for(var c=[];a&&!b(a);)c.push(a),a=a.previousSibling;return c},listDescendant:function(a,b){var c=[];b=b||f.ok;(function Pa(d){a!==d&&b(d)&&c.push(d);for(var e=0,f=d.childNodes.length;e<f;e++)Pa(d.childNodes[e])})(a);return c},commonAncestor:function(b,c){for(var d=q(b),e=c;e;e=e.parentNode)if(-1<a.inArray(e,d))return e;return null},wrap:function(b,c){var d=b.parentNode,e=a("<"+c+">")[0];d.insertBefore(e,b);e.appendChild(b);return e},insertAfter:da,appendChildNodes:ba,position:O,hasChildren:U,
makeOffsetPath:function(b,c){var d=q(c,f.eq(b));return a.map(d,O).reverse()},fromOffsetPath:function(a,b){for(var c=a,d=0,e=b.length;d<e;d++)c=c.childNodes.length<=b[d]?c.childNodes[c.childNodes.length-1]:c.childNodes[b[d]];return c},splitTree:L,splitPoint:function(a,b){var d=b?l:Y,e=q(a.node,d),f=c.last(e)||a.node;d(f)?d=e[e.length-2]:(d=f,f=d.parentNode);return{rightNode:d&&L(d,a,b),container:f}},create:I,createText:function(a){return document.createTextNode(a)},remove:H,removeWhile:function(a,
b){for(;a&&!g(a)&&b(a);){var c=a.parentNode;H(a);a=c}},replace:function(a,b){if(a.nodeName.toUpperCase()===b.toUpperCase())return a;var d=I(b);a.style.cssText&&(d.style.cssText=a.style.cssText);ba(d,c.from(a.childNodes));da(d,a);H(a);return d},html:function(b,c){var d=M(b[0])?b.val():b.html();c&&(d=d.replace(/<(\/?)(\b(?!!)[^>\s]*)(.*?)(\s*\/?>)/g,function(a,b,c){c=c.toUpperCase();b=/^DIV|^TD|^TH|^P|^LI|^H[1-7]/.test(c)&&!!b;c=/^BLOCKQUOTE|^TABLE|^TBODY|^TR|^HR|^UL|^OL/.test(c);return a+(b||c?"\n":
...
c.offset,a.node,a.offset)};this.nodes=function(a,d){a=a||f.ok;var e=d&&d.includeAncestor,g=d&&d.fullyContains,k=this.getStartPoint(),h=this.getEndPoint(),p=[],l=[];b.walkPoint(k,h,function(d){if(!b.isEditable(d.node)){var f;g?(b.isLeftEdgePoint(d)&&l.push(d.node),b.isRightEdgePoint(d)&&c.contains(l,d.node)&&(f=d.node)):f=e?b.ancestor(d.node,a):d.node;f&&a(f)&&p.push(f)}},!0);return c.unique(p)};this.commonAncestor=function(){return b.commonAncestor(e,l)};this.expand=function(a){var c=b.ancestor(e,
...
b.css({display:"",width:Math.min(a.width(),b.width())});k.create().insertNode(b[0]);k.createFromNode(b[0]).collapse().select();v(a)}).fail(function(){var b=a.data("callbacks");if(b.onImageUploadError)b.onImageUploadError()})};this.insertNode=function(a,b){J(a);this.createRange(a).insertNode(b);k.createFromNode(b).collapse().select();v(a)};this.insertText=function(a,c){J(a);var d=this.createRange(a).insertNode(b.createText(c));k.create(d,b.nodeLength(d)).select();v(a)};this.formatBlock=function(a,
b){J(a);b=d.isMSIE?"<"+b+">":b;document.execCommand("FormatBlock",!1,b);v(a)};this.formatPara=function(a){J(a);this.formatBlock(a,"P");v(a)};for(A=1;6>=A;A++)this["formatH"+A]=function(a){return function(b){this.formatBlock(b,"H"+a)}}(A);this.fontSize=function(a,b){J(a);document.execCommand("fontSize",!1,3);d.isFF?a.find("font[size=3]").removeAttr("size").css("font-size",b+"px"):a.find("span").filter(function(){return"medium"===this.style.fontSize}).css("font-size",b+"px");v(a)};this.lineHeight=function(a,
b){J(a);e.stylePara(k.create(),{lineHeight:b});v(a)};this.unlink=function(a){var c=k.create();c.isOnAnchor()&&(c=b.ancestor(c.sc,b.isAnchor),c=k.createFromNode(c),c.select(),J(a),document.execCommand("unlink"),v(a))};this.createLink=function(b,d,f){var g=d.url,h=d.text,l=d.newWindow;d=d.range;var m=d.toString()!==h;J(b);f.onCreateLink&&(g=f.onCreateLink(g));h=m?[d.insertNode(a("<A>"+h+"</A>")[0])]:e.styleNodes(d,{nodeName:"A",expandClosestSibling:!0,onlyPartialContains:!0});a.each(h,function(b,c){a(c).attr({href:g,
target:l?"_blank":""})});f=k.createFromNode(c.head(h)).collapse(!0).getStartPoint();h=k.createFromNode(c.last(h)).collapse().getEndPoint();k.create(f.node,f.offset,h.node,h.offset).select();v(b)};this.getLinkInfo=function(d){d.focus();d=k.create().expand(b.isAnchor);var e=a(c.head(d.nodes(b.isAnchor)));return{range:d,text:d.toString(),isNewWindow:e.length?"_blank"===e.attr("target"):!0,url:e.length?e.attr("href"):""}};this.color=function(a,b){var c=JSON.parse(b),d=c.foreColor,c=c.backColor;J(a);d&&
document.execCommand("foreColor",!1,d);c&&document.execCommand("backColor",!1,c);v(a)};this.insertTable=function(a,b){var c=b.split("x");J(a);var d=k.create(),d=d.deleteContents();d.insertNode(f.createTable(c[0],c[1]));v(a)};this.floatMe=function(a,b,c){J(a);c.css("float",b);v(a)};this.imageShape=function(a,b,c){J(a);c.removeClass("img-rounded img-circle img-thumbnail");b&&c.addClass(b);v(a)};this.resize=function(a,b,c){J(a);c.css({width:100*b+"%",height:""});v(a)};this.resizeTo=function(a,b,c){if(c){c=
a.y/a.x;var d=b.data("ratio");a={width:d>c?a.x:a.y/d,height:d>c?a.x*d:a.y}}else a={width:a.x,height:a.y};b.css(a)};this.removeMedia=function(a,b,c){J(a);c.detach();if((b=a.data("callbacks"))&&b.onMediaDelete)b.onMediaDelete(c,this,a);v(a)}},C=function(a){var b=[],c=-1,d=a[0],e=function(){var b=k.create(),c={s:{path:[0],offset:0},e:{path:[0],offset:0}};return{contents:a.html(),bookmark:b?b.bookmark(d):c}},f=function(b){null!==b.contents&&a.html(b.contents);null!==b.bookmark&&k.createFromBookmark(d,
b.bookmark).select()};this.undo=function(){0<c&&(c--,f(b[c]))};this.redo=function(){b.length-1>c&&(c++,f(b[c]))};this.recordUndo=function(){c++;b.length>c&&(b=b.slice(0,c));b.push(e())};this.recordUndo()},s=function(){this.update=function(b,d){var e=function(b,c){b.find(".dropdown-menu li a").each(function(){this.className=a(this).data("value")+""===c+""?"checked":""})},f=function(a,c){b.find(a).toggleClass("active",c())};if(d.image){var g=a(d.image);f('button[data-event="imageShape"][data-value="img-rounded"]',
function(){return g.hasClass("img-rounded")});f('button[data-event="imageShape"][data-value="img-circle"]',function(){return g.hasClass("img-circle")});f('button[data-event="imageShape"][data-value="img-thumbnail"]',function(){return g.hasClass("img-thumbnail")});f('button[data-event="imageShape"]:not([data-value])',function(){return!g.is(".img-rounded, .img-circle, .img-thumbnail")});var h=g.css("float");f('button[data-event="floatMe"][data-value="left"]',function(){return"left"===h});f('button[data-event="floatMe"][data-value="right"]',
function(){return"right"===h});f('button[data-event="floatMe"][data-value="none"]',function(){return"left"!==h&&"right"!==h});var k=g.attr("style");f('button[data-event="resize"][data-value="1"]',function(){return!!/(^|\s)(max-)?width\s*:\s*100%/.test(k)});f('button[data-event="resize"][data-value="0.5"]',function(){return!!/(^|\s)(max-)?width\s*:\s*50%/.test(k)});f('button[data-event="resize"][data-value="0.25"]',function(){return!!/(^|\s)(max-)?width\s*:\s*25%/.test(k)})}else{var l=b.find(".note-fontname");
if(l.length){var m=d["font-family"];m&&(m=c.head(m.split(",")),m=m.replace(/\'/g,""),l.find(".note-current-fontname").text(m),e(l,m))}l=b.find(".note-fontsize");l.find(".note-current-fontsize").text(d["font-size"]);e(l,parseFloat(d["font-size"]));l=b.find(".note-height");e(l,parseFloat(d["line-height"]));f('button[data-event="bold"]',function(){return"bold"===d["font-bold"]});f('button[data-event="italic"]',function(){return"italic"===d["font-italic"]});f('button[data-event="underline"]',function(){return"underline"===
d["font-underline"]});f('button[data-event="strikethrough"]',function(){return"strikethrough"===d["font-strikethrough"]});f('button[data-event="superscript"]',function(){return"superscript"===d["font-superscript"]});f('button[data-event="subscript"]',function(){return"subscript"===d["font-subscript"]});f('button[data-event="justifyLeft"]',function(){return"left"===d["text-align"]||"start"===d["text-align"]});f('button[data-event="justifyCenter"]',function(){return"center"===d["text-align"]});f('button[data-event="justifyRight"]',
function(){return"right"===d["text-align"]});f('button[data-event="justifyFull"]',function(){return"justify"===d["text-align"]});f('button[data-event="insertUnorderedList"]',function(){return"unordered"===d["list-style"]});f('button[data-event="insertOrderedList"]',function(){return"ordered"===d["list-style"]})}};this.updateRecentColor=function(b,c,d){b=a(b).closest(".note-color").find(".note-recent-color");var e=JSON.parse(b.attr("data-value"));e[c]=d;b.attr("data-value",JSON.stringify(e));c="backColor"===
c?"background-color":"color";b.find("i").css(c,d)}},H=function(){var a=new s;this.update=function(b,c){a.update(b,c)};this.updateRecentColor=function(b,c,d){a.updateRecentColor(b,c,d)};this.activate=function(a){a.find("button").not('button[data-event="codeview"]').removeClass("disabled")};this.deactivate=function(a){a.find("button").not('button[data-event="codeview"]').addClass("disabled")};this.updateFullscreen=function(a,b){a.find('button[data-event="fullscreen"]').toggleClass("active",b)};this.updateCodeview=
function(a,b){a.find('button[data-event="codeview"]').toggleClass("active",b)}},Q=function(){var b=new s,d=function(b,c){var d=a(b),e=c?d.offset():d.position(),d=d.outerHeight(!0);return{left:e.left,top:e.top+d}},e=function(a,b){a.css({display:"block",left:b.left,top:b.top})};this.update=function(g,h,k){b.update(g,h);var l=g.find(".note-link-popover");if(h.anchor){var m=l.find("a"),n=a(h.anchor).attr("href");m.attr("href",n).html(n);e(l,d(h.anchor,k))}else l.hide();l=g.find(".note-image-popover");
...
b.css({display:"block",left:d.left,top:d.top,width:f,height:e}).data("target",c.image);c=f+"x"+e;b.find(".note-control-selection-info").text(c)}else b.hide()};this.hide=function(a){a.children().hide()}},M=function(){var b=function(a,b){a.toggleClass("disabled",!b);a.attr("disabled",!b)};this.showImageDialog=function(c,d){return a.Deferred(function(a){var c=d.find(".note-image-dialog"),e=d.find(".note-image-input"),f=d.find(".note-image-url"),g=d.find(".note-image-btn");c.one("shown.bs.modal",function(){e.replaceWith(e.clone().on("change",
function(){a.resolve(this.files||this.value);c.modal("hide")}).val(""));g.click(function(b){b.preventDefault();a.resolve(f.val());c.modal("hide")});f.on("keyup paste",function(a){a="paste"===a.type?a.originalEvent.clipboardData.getData("text"):f.val();b(g,a)}).val("").trigger("focus")}).one("hidden.bs.modal",function(){e.off("change");f.off("keyup paste");g.off("click");"pending"===a.state()&&a.reject()}).modal("show")})};this.showLinkDialog=function(c,d,e){return a.Deferred(function(a){var c=d.find(".note-link-dialog"),
f=c.find(".note-link-text"),g=c.find(".note-link-url"),h=c.find(".note-link-btn"),k=c.find("input[type=checkbox]");c.one("shown.bs.modal",function(){f.val(e.text);f.on("input",function(){e.text=f.val()});e.url||(e.url=e.text,b(h,e.text));g.on("input",function(){b(h,g.val());e.text||f.val(g.val())}).val(e.url).trigger("focus").trigger("select");k.prop("checked",e.newWindow);h.one("click",function(b){b.preventDefault();a.resolve({range:e.range,url:g.val(),text:f.val(),newWindow:k.is(":checked")});c.modal("hide")})}).one("hidden.bs.modal",
function(){f.off("input");g.off("input");h.off("click");"pending"===a.state()&&a.reject()}).modal("show")}).promise()};this.showHelpDialog=function(b,c){return a.Deferred(function(a){c.find(".note-help-dialog").one("hidden.bs.modal",function(){a.resolve()}).modal("show")}).promise()}},V;d.hasCodeMirror&&(d.isSupportAmd?require(["CodeMirror"],function(a){V=a}):V=window.CodeMirror);a.summernote=a.summernote||{};a.extend(a.summernote,{version:"0.6.2",options:{width:null,height:null,minHeight:null,maxHeight:null,
focus:!1,tabsize:4,styleWithSpan:!0,disableLinkTarget:!1,disableDragAndDrop:!1,disableResizeEditor:!1,shortcuts:!0,placeholder:!1,prettifyHtml:!0,codemirror:{mode:"text/html",htmlMode:!0,lineNumbers:!0},lang:"zh-CN",direction:null,toolbar:[["style",["style"]],["font",["bold","italic","underline","clear"]],["fontname",["fontname"]],["color",["color"]],["para",["ul","ol","paragraph"]],["height",["height"]],["table",["table"]],["insert",["link","picture","hr"]],["view",["fullscreen","codeview"]],["help",
["help"]]],airMode:!1,airPopover:[["color",["color"]],["font",["bold","underline","clear"]],["para",["ul","paragraph"]],["table",["table"]],["insert",["link","picture"]]],styleTags:"p blockquote pre h1 h2 h3 h4 h5 h6".split(" "),defaultFontName:"Helvetica Neue",fontNames:"Arial;Arial Black;Comic Sans MS;Courier New;Helvetica Neue;Impact;Lucida Grande;Tahoma;Times New Roman;Verdana".split(";"),fontNamesIgnoreCheck:[],colors:["#000000 #424242 #636363 #9C9C94 #CEC6CE #EFEFEF #F7F7F7 #FFFFFF".split(" "),
...
"CMD+RIGHTBRACKET":"indent","CMD+NUM0":"formatPara","CMD+NUM1":"formatH1","CMD+NUM2":"formatH2","CMD+NUM3":"formatH3","CMD+NUM4":"formatH4","CMD+NUM5":"formatH5","CMD+NUM6":"formatH6","CMD+ENTER":"insertHorizontalRule","CMD+K":"showLinkDialog"}}},lang:{}});var R=new function(){var c=function(a,b){var c=b.event,d=b.value,e=b.title,f=b.className,g=b.dropdown,h=b.hide;return'<button type="button" class="btn btn-default btn-sm btn-small'+(f?" "+f:"")+(g?" dropdown-toggle":"")+'"'+(g?' data-toggle="dropdown"':
...
k[r[s]];a.isFunction(T)&&(h+=T(f,e))}h+="</div>"}p=a('<div class="note-toolbar btn-toolbar">'+h+"</div>").prependTo(g);h=e.keyMap[d.isMac?"mac":"pc"];H(p,e);C(p,h,"bottom");p=a(l(f,e)).prependTo(g);H(p,e);C(p,h);a(m()).prependTo(g);a(y(f,e)).prependTo(g).find("button.close, a.modal-close").click(function(){a(this).closest(".modal").modal("hide")});a('<div class="note-dropzone"><div class="note-dropzone-message"></div></div>').prependTo(g);g.insertAfter(c);c.hide()};this.noteEditorFromHolder=function(b){return b.hasClass("note-air-editor")?
...
b.handle.remove(),b.dialog.remove()):(a.html(b.editable.html()),b.editor.remove(),a.show())};this.getTemplate=function(){return{button:c,iconButton:e,dialog:h}};this.addButtonInfo=function(a,b){k[a]=b};this.addDialogInfo=function(a,b){u[a]=b}},ha=new function(){var e=a(window),f=a(document),h=a("html, body"),k=new v,l=new H,m=new Q,n=new Z,s=new M;this.getEditor=function(){return k};var u=function(d){d=a(d).closest(".note-editor, .note-air-editor, .note-air-layout");if(!d.length)return null;d=d.is(".note-editor, .note-air-editor")?
d:a("#note-editor-"+c.last(d.attr("id").split("-")));return b.buildLayoutInfo(d)},A=function(b,c){var d=b.editor(),e=b.editable(),f=e.data("callbacks"),g=d.data("options");if(f.onImageUpload)f.onImageUpload(c,k,e);else{var h=new FormData,l=[],g=d.data("options");a.each(c,function(a,b){l.push(b.name);h.append((g.uploadPerfix||"upload_file")+a,b)});a.ajax({url:g.uploadURI+"",type:"POST",data:h,cache:!1,contentType:!1,processData:!1,success:function(b){try{b=JSON.parse(b)}catch(c){}if(b.success&&b.data)a.each(b.data,
function(a,b){k.insertImage(e,b.url,l[a])});else if(f.onImageUploadError)f.onImageUploadError(b)},error:function(){if(f.onImageUploadError)f.onImageUploadError()}})}},y={showLinkDialog:function(a){var b=a.editor(),c=a.dialog(),d=a.editable(),e=k.getLinkInfo(d),f=b.data("options");k.saveRange(d);s.showLinkDialog(d,c,e).then(function(b){k.restoreRange(d);k.createLink(d,b,f);m.hide(a.popover())}).fail(function(){k.restoreRange(d)})},showImageDialog:function(a){var b=a.dialog(),c=a.editable();k.saveRange(c);
...
l.deactivate(e),m.hide(h),n.hide(k),g.focus(),d.hasCodeMirror&&(h=V.fromTextArea(g[0],p.codemirror),p.codemirror.tern&&(q=new V.TernServer(p.codemirror.tern),h.ternServer=q,h.on("cursorActivity",function(a){q.updateArgHints(a)})),h.setSize(null,f.outerHeight()),g.data("cmEditor",h))):(d.hasCodeMirror&&(h=g.data("cmEditor"),g.val(h.getValue()),h.toTextArea()),f.html(b.value(g,p.prettifyHtml)||b.emptyPara),f.height(p.height?g.height():"auto"),l.activate(e),f.focus());l.updateCodeview(a.toolbar(),c)}},
R=function(a){b.isImg(a.target)&&a.preventDefault()},S=function(a){setTimeout(function(){var b=u(a.currentTarget||a.target),c=k.currentStyle(a.target);if(c){var d=b.editor().data("options").airMode;d||l.update(b.toolbar(),c);m.update(b.popover(),c,d);n.update(b.handle(),c,d)}},0)},ha=function(a){a=u(a.currentTarget||a.target);m.hide(a.popover());n.hide(a.handle())},K=function(b){var d=b.originalEvent.clipboardData,e=u(b.currentTarget||b.target),f=e.editable();d&&d.items&&d.items.length?(b=c.head(d.items),
...
n=a(n.data("target")));g&&d.parents(".popover").hide();if(a.isFunction(a.summernote.pluginEvents[e]))a.summernote.pluginEvents[e](b,k,h,f);else k[e]?(g=h.editable(),g.trigger("focus"),k[e](g,f,n),b.preventDefault()):y[e]&&(y[e].call(this,h),b.preventDefault());if(-1!==a.inArray(e,["backColor","foreColor"])){var q=h.editor().data("options",q);(q.airMode?m:l).updateRecentColor(c.head(d),e,f)}S(b)}},G=function(a){a.preventDefault();a.stopPropagation();var b=u(a.target).editable(),c=b.offset().top-f.scrollTop(),
d=u(a.currentTarget||a.target).editor().data("options");f.on("mousemove",function(a){a=a.clientY-(c+24);a=0<d.minHeight?Math.max(a,d.minHeight):a;a=0<d.maxHeight?Math.min(a,d.maxHeight):a;b.height(a)}).one("mouseup",function(){f.off("mousemove")})},q=function(a,b){if(b.disableDragAndDrop)f.on("drop",function(a){a.preventDefault()});else W(a,b)},W=function(b,c){var d=a(),e=b.dropzone,g=b.dropzone.find(".note-dropzone-message");f.on("dragenter",function(a){b.editor.hasClass("codeview")||d.length||(b.editor.addClass("dragover"),
...
e);else b.editable.on("input",e);b.editable.data("callbacks",{onBeforeChange:c.onBeforeChange,onChange:c.onChange,onAutoSave:c.onAutoSave,onImageUpload:c.onImageUpload,onImageUploadError:c.onImageUploadError,onFileUpload:c.onFileUpload,onFileUploadError:c.onFileUpload,onMediaDelete:c.onMediaDelete})};this.detach=function(a,b){a.editable.off();a.popover.off();a.handle.off();a.dialog.off();b.airMode||(a.dropzone.off(),a.toolbar.off(),a.statusbar.off())}};a.extend(a.summernote,{renderer:R,eventHandler:ha,
core:{agent:d,dom:b,range:k},pluginEvents:{}});a.summernote.addPlugin=function(b){b.buttons&&a.each(b.buttons,function(a,b){R.addButtonInfo(a,b)});b.dialogs&&a.each(b.dialogs,function(a,b){R.addDialogInfo(a,b)});b.events&&a.each(b.events,function(b,c){a.summernote.pluginEvents[b]=c});b.langs&&a.each(b.langs,function(b,c){a.summernote.lang[b]&&a.extend(a.summernote.lang[b],c)});b.options&&a.extend(a.summernote.options,b.options)};a.fn.extend({summernote:function(c){c=a.extend({},a.summernote.options,
c);c.langInfo=a.extend(!0,{},a.summernote.lang["zh-CN"],a.summernote.lang[c.lang]);this.each(function(d,e){var f=a(e);R.createLayout(f,c);var g=R.layoutInfoFromHolder(f);ha.attach(g,c);b.isTextarea(f[0])&&f.closest("form").submit(function(){var a=f.code();f.val(a);if(c.onsubmit)c.onsubmit(a)})});this.first().length&&c.focus&&R.layoutInfoFromHolder(this.first()).editable.focus();if(this.length&&c.oninit)c.oninit();return this},code:function(c){if(void 0===c){var e=this.first();if(!e.length)return;
var f=R.layoutInfoFromHolder(e);return f&&f.editable?((e=f.editor.hasClass("codeview"))&&d.hasCodeMirror&&f.codable.data("cmEditor").save(),e?f.codable.val():f.editable.html()):b.isTextarea(e[0])?e.val():e.html()}this.each(function(b,d){var e=R.layoutInfoFromHolder(a(d));e&&e.editable&&e.editable.html(c)});return this},destroy:function(){this.each(function(b,c){var d=a(c),e=R.layoutInfoFromHolder(d);if(e&&e.editable){var f=e.editor.data("options");ha.detach(e,f);R.removeLayout(d,e,f)}});return this}})});(function(a){a.extend(a.summernote.lang,{"zh-CN":{font:{bold:"粗体",italic:"斜体",underline:"下划线",strikethrough:"删除线",clear:"清除格式",height:"行高",name:"字体",size:"字号"},image:{image:"图片",insert:"插入图片",resizeFull:"调整至 100%",resizeHalf:"调整至 50%",resizeQuarter:"调整至 25%",floatLeft:"左浮动",floatRight:"右浮动",floatNone:"不浮动",dragImageHere:"将图片拖至此处",selectFromFiles:"从本地上传",url:"图片地址"},link:{link:"链接",insert:"插入链接",unlink:"去除链接",edit:"编辑链接",textToDisplay:"显示文本",url:"链接地址",openInNewWindow:"在新窗口打开"},video:{video:"视频",videoLink:"视频链接",
