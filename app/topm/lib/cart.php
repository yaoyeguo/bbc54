...
class topm_cart{
    ...
    public function getCartInfo()
    {
        ...
        if( userAuth::check())
        {
            $cartData = app::get('topm')->rpcCall('trade.cart.getCartInfo', array('platform'=>'pc','user_id'=>userAuth::id()), 'buyer');
        }
        else
        {
    ...
    public function mergeCart()
    {
        ...
        $cookieCartCount = kernel::single('topm_cart_offline')->getCartCount();
        $countData = app::get('topm')->rpcCall('trade.cart.getCount', ['user_id' => userAuth::id()], 'buyer');
