...
class ectools_api_payment_recharge{
    ...
    public function doRecharge($params)
    {
        ...
        $url = $params['platform'] == 'pc' ? serialize(['topc_ctl_member_deposit@rechargeResult', ['payment_id'=>$paymentId]]) : serialize(['topm_ctl_member_deposit@rechargeResult', ['payment_id'=>$paymentId]]);
