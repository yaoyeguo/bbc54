...
class sysaftersales_finder_refunds {
    ...
    public function detail_basic($Id)
    {
        ...
        if($refundRow['status'] == '1')
        {
            ...
            $refundRow['refunds_view'] = $objEctoolsRefunds->getRow('refund_bank,refund_account,refund_people,receive_bank,receive_account,beneficiary',$filter);
