...
class sysaftersales_api_refundapply_restore {
    ...
    public function getParams()
    {
        $return['params'] = array(
            ...
            'return_fee' => ['type'=>'json','valid'=>'required', 'description'=>'退款金额'],
        );
        return $return;
    }
    ...
    public function update($params)
    {
        ...
        $refunds = $objMdlRefunds->getRow('refunds_id,refund_bn,status,aftersales_bn,refund_fee,total_price,refunds_type,user_id,shop_id,tid,oid,return_freight',$filter);
        ...
        try
        {
            ...
            {
                //取消退款成功后，更新取消成功后操作
                app::get('sysaftersales')->rpcCall('trade.cancel.succ',['tid'=>$refunds['tid'],'shop_id'=>$refunds['shop_id']]);
