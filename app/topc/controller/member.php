...
class topc_ctl_member extends topc_controller {
    ...
    public function index()
    {
        ...
        $tradeParams['fields'] = 'tid,shop_id,user_id,status,payment,points_fee,total_fee,post_fee,payed_fee,pay_type,receiver_name,created_time,receiver_mobile,discount_fee,need_invoice,adjust_fee,order.title,order.price,order.num,order.pic_path,order.tid,order.oid,order.item_id,activity';
        $tradelist = app::get('topc')->rpcCall('trade.get.list',$tradeParams);
        $pagedata['trades'] = $tradelist['list'];
        //echo '<pre>';print_r($tradelist);exit();
        //会员收藏
...
//echo '<pre>';print_r($pagedata);exit();
    ...
    public function tradeStatusList()
    {
        ...
        $tradeParams['fields'] = 'tid,shop_id,user_id,status,payment,points_fee,total_fee,post_fee,payed_fee,receiver_name,created_time,receiver_mobile,discount_fee,need_invoice,adjust_fee,order.title,order.price,order.num,order.pic_path,order.tid,order.oid,order.item_id,order.seller_rate,activity';
        $tradelist = app::get('topc')->rpcCall('trade.get.list',$tradeParams);
        $pagedata['trades'] = $tradelist['list'];
